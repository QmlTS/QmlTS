...
export function GraphTransition(): GraphTransitionBuilder {
  return createFluentBuilder('GraphTransition', GRAPHTRANSITION_META) as unknown as GraphTransitionBuilder;
}
...
export namespace GraphTransition {
  export namespace TransitionType {
    ...
    export const PointReplaced = createEnumToken('GraphTransition', 'TransitionType', 'PointReplaced');
    export const PointRemoved = createEnumToken('GraphTransition', 'TransitionType', 'PointRemoved');
  }
}
