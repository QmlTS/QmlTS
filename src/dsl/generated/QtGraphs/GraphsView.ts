...
export interface GraphsViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): GraphsViewBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onAxisXChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onAxisXSmoothingChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onAxisYChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onAxisYSmoothingChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onClipPlotAreaChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onGridSmoothingChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onHover(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onHoverEnter(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onHoverExit(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onMarginBottomChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onMarginLeftChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onMarginRightChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onMarginTopChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onPanStyleChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onPlotAreaChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowBarWidthChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowColorChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowSmoothingChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowVisibleChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowXOffsetChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onShadowYOffsetChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onThemeChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onZoomAreaDelegateChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onZoomAreaEnabledChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onZoomSensitivityChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
  onZoomStyleChanged(handler: DslSignalHandlerValue): GraphsViewBuilder;
