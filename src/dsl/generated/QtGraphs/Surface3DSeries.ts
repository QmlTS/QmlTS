...
export interface Surface3DSeriesBuilder {
  ...
  baseGradient(value: GradientBuilder): Surface3DSeriesBuilder;
  ...
  multiHighlightGradient(value: GradientBuilder): Surface3DSeriesBuilder;
  ...
  singleHighlightGradient(value: GradientBuilder): Surface3DSeriesBuilder;
...
const SURFACE3DSERIES_META: TypeMetadata = {
  ...
  signals: [
    ...
    { handlerName: 'onGradientsChanged', paramCount: 0 },
