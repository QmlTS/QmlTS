...
export interface Surface3DBuilder {
  ...
  onActiveThemeChanged(body: string): Surface3DBuilder;
  onAmbientLightStrengthChanged(body: string): Surface3DBuilder;
  ...
  onCameraChanged(body: string): Surface3DBuilder;
  onCameraPresetChanged(body: string): Surface3DBuilder;
  onCameraTargetPositionChanged(body: string): Surface3DBuilder;
  onCameraXRotationChanged(body: string): Surface3DBuilder;
  onCameraYRotationChanged(body: string): Surface3DBuilder;
  onCameraZoomLevelChanged(body: string): Surface3DBuilder;
  ...
  onCutoffMarginChanged(body: string): Surface3DBuilder;
  onDoubleTapped(body: string): Surface3DBuilder;
  onDragged(body: string): Surface3DBuilder;
  onEffectiveTextureSizeChanged(body: string): Surface3DBuilder;
  onEnabledChanged(body: string): Surface3DBuilder;
  onEnvironmentChanged(body: string): Surface3DBuilder;
  onExplicitTextureHeightChanged(body: string): Surface3DBuilder;
  onExplicitTextureWidthChanged(body: string): Surface3DBuilder;
  ...
  onGridLineTypeChanged(body: string): Surface3DBuilder;
  ...
  onImportSceneChanged(body: string): Surface3DBuilder;
  onLabelMarginChanged(body: string): Surface3DBuilder;
  onLightColorChanged(body: string): Surface3DBuilder;
  onLightStrengthChanged(body: string): Surface3DBuilder;
  onLocaleChanged(body: string): Surface3DBuilder;
  onLongPressed(body: string): Surface3DBuilder;
  onMarginChanged(body: string): Surface3DBuilder;
  onMaxCameraXRotationChanged(body: string): Surface3DBuilder;
  onMaxCameraYRotationChanged(body: string): Surface3DBuilder;
  onMaxCameraZoomLevelChanged(body: string): Surface3DBuilder;
  onMeasureFpsChanged(body: string): Surface3DBuilder;
  onMinCameraXRotationChanged(body: string): Surface3DBuilder;
  onMinCameraYRotationChanged(body: string): Surface3DBuilder;
  onMinCameraZoomLevelChanged(body: string): Surface3DBuilder;
  onMouseMove(body: string): Surface3DBuilder;
  onMsaaSamplesChanged(body: string): Surface3DBuilder;
  onNeedRender(body: string): Surface3DBuilder;
  onObjectNameChanged(body: string): Surface3DBuilder;
  onOpacityChanged(body: string): Surface3DBuilder;
  onOptimizationHintChanged(body: string): Surface3DBuilder;
  ...
  onPinch(body: string): Surface3DBuilder;
  ...
  onRenderFormatChanged(body: string): Surface3DBuilder;
  onRenderModeChanged(body: string): Surface3DBuilder;
  onRenderOverridesChanged(body: string): Surface3DBuilder;
  onRenderingModeChanged(body: string): Surface3DBuilder;
  onRotationChanged(body: string): Surface3DBuilder;
  onRotationEnabledChanged(body: string): Surface3DBuilder;
...
export namespace Surface3D {
  ...
  export namespace RenderOverride {
    ...
    export const DisableInternalPasses = createEnumToken('Surface3D', 'RenderOverride', 'DisableInternalPasses');
  }
  export namespace RenderOverrides {
    export const None = createEnumToken('Surface3D', 'RenderOverrides', 'None');
    export const DisableInternalPasses = createEnumToken('Surface3D', 'RenderOverrides', 'DisableInternalPasses');
  }
