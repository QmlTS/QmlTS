...
export interface Scatter3DSeriesBuilder {
  ...
  baseGradient(value: GradientBuilder): Scatter3DSeriesBuilder;
  ...
  multiHighlightGradient(value: GradientBuilder): Scatter3DSeriesBuilder;
  ...
  singleHighlightGradient(value: GradientBuilder): Scatter3DSeriesBuilder;
