...
export function BusyIndicator(): BusyIndicatorBuilder {
  return createFluentBuilder('BusyIndicator', BUSYINDICATOR_META) as unknown as BusyIndicatorBuilder;
}

export namespace BusyIndicator {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('BusyIndicator', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('BusyIndicator', 'Flags', 'ItemAcceptsInputMethod');
    ...
    export const ItemObservesViewport = createEnumToken('BusyIndicator', 'Flags', 'ItemObservesViewport');
  }
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('BusyIndicator', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('BusyIndicator', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('BusyIndicator', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('BusyIndicator', 'ItemChange', 'ItemTransformHasChanged');
  }
