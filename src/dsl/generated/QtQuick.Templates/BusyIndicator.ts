...
export interface BusyIndicatorBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): BusyIndicatorBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onClipChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onFontChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onParentChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onRunningChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onStateChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onXChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onYChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
  onZChanged(handler: DslSignalHandlerValue): BusyIndicatorBuilder;
