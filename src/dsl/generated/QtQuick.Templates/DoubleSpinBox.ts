...
export interface DoubleSpinBoxBuilder {
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onDecimalsChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onDisplayTextChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onEditableChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onFontChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onFromChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onInputMethodComposingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onInputMethodHintsChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onRightInsetChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onSpacingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onStateChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onStepSizeChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onTextFromValueChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onToChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onValidatorChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onValueChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onValueFromTextChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onValueModified(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
  ...
  onWrapChanged(handler: DslSignalHandlerValue): DoubleSpinBoxBuilder;
