...
export interface MenuItemBuilder {
  ...
  onActionChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onArrowChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onCanceled(handler: DslSignalHandlerValue): MenuItemBuilder;
  ...
  onChildrenChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onClicked(handler: DslSignalHandlerValue): MenuItemBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): MenuItemBuilder;
  onDownChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onFontChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onIconChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitTextPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onMenuChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MenuItemBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPressed(handler: DslSignalHandlerValue): MenuItemBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onReleased(handler: DslSignalHandlerValue): MenuItemBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  ...
  onTextPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onToggled(handler: DslSignalHandlerValue): MenuItemBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onTriggered(handler: DslSignalHandlerValue): MenuItemBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onXChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onYChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
  onZChanged(handler: DslSignalHandlerValue): MenuItemBuilder;
