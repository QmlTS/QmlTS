...
export interface ProgressBarBuilder {
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onFromChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onIndeterminateChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onPositionChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onSpacingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onToChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onValueChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onVisualPositionChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ProgressBarBuilder;
