...
export interface TabBarBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TabBarBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onCountChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onFontChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TabBarBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onXChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onYChanged(handler: DslSignalHandlerValue): TabBarBuilder;
  onZChanged(handler: DslSignalHandlerValue): TabBarBuilder;
