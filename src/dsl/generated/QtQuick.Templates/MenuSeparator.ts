...
export interface MenuSeparatorBuilder {
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onFontChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onXChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onYChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
  onZChanged(handler: DslSignalHandlerValue): MenuSeparatorBuilder;
