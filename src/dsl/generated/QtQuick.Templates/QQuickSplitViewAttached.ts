...
export interface SplitViewAttachedBuilder {
  ...
  fillWidth(value: boolean): SplitViewAttachedBuilder;
  fillWidthBind(expr: string): SplitViewAttachedBuilder;
  maximumHeight(value: number): SplitViewAttachedBuilder;
  maximumHeightBind(expr: string): SplitViewAttachedBuilder;
  maximumWidth(value: number): SplitViewAttachedBuilder;
  maximumWidthBind(expr: string): SplitViewAttachedBuilder;
  minimumHeight(value: number): SplitViewAttachedBuilder;
  minimumHeightBind(expr: string): SplitViewAttachedBuilder;
  minimumWidth(value: number): SplitViewAttachedBuilder;
  minimumWidthBind(expr: string): SplitViewAttachedBuilder;
  preferredHeight(value: number): SplitViewAttachedBuilder;
  preferredHeightBind(expr: string): SplitViewAttachedBuilder;
  preferredWidth(value: number): SplitViewAttachedBuilder;
