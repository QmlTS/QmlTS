...
export interface TumblerBuilder {
  ...
  onActiveFocusChanged(body: string): TumblerBuilder;
  onActiveFocusOnTabChanged(body: string): TumblerBuilder;
  onAntialiasingChanged(body: string): TumblerBuilder;
  onAvailableHeightChanged(body: string): TumblerBuilder;
  onAvailableWidthChanged(body: string): TumblerBuilder;
  onBackgroundChanged(body: string): TumblerBuilder;
  onBaselineOffsetChanged(body: string): TumblerBuilder;
  onBottomInsetChanged(body: string): TumblerBuilder;
  onBottomPaddingChanged(body: string): TumblerBuilder;
  onChildrenChanged(body: string): TumblerBuilder;
  onChildrenRectChanged(body: string): TumblerBuilder;
  onClipChanged(body: string): TumblerBuilder;
  onContainmentMaskChanged(body: string): TumblerBuilder;
  onContentItemChanged(body: string): TumblerBuilder;
  onCountChanged(body: string): TumblerBuilder;
  onCurrentIndexChanged(body: string): TumblerBuilder;
  onCurrentItemChanged(body: string): TumblerBuilder;
  onDelegateChanged(body: string): TumblerBuilder;
  onEnabledChanged(body: string): TumblerBuilder;
  onFlickDecelerationChanged(body: string): TumblerBuilder;
  onFocusChanged(body: string): TumblerBuilder;
  onFocusPolicyChanged(body: string): TumblerBuilder;
  onFocusReasonChanged(body: string): TumblerBuilder;
  onFontChanged(body: string): TumblerBuilder;
  onHeightChanged(body: string): TumblerBuilder;
  onHorizontalPaddingChanged(body: string): TumblerBuilder;
  onHoverEnabledChanged(body: string): TumblerBuilder;
  onHoveredChanged(body: string): TumblerBuilder;
  onImplicitBackgroundHeightChanged(body: string): TumblerBuilder;
  onImplicitBackgroundWidthChanged(body: string): TumblerBuilder;
  onImplicitContentHeightChanged(body: string): TumblerBuilder;
  onImplicitContentWidthChanged(body: string): TumblerBuilder;
  onImplicitHeightChanged(body: string): TumblerBuilder;
  onImplicitWidthChanged(body: string): TumblerBuilder;
  onLeftInsetChanged(body: string): TumblerBuilder;
  onLeftPaddingChanged(body: string): TumblerBuilder;
  onLocaleChanged(body: string): TumblerBuilder;
  onMirroredChanged(body: string): TumblerBuilder;
  onModelChanged(body: string): TumblerBuilder;
  onMovingChanged(body: string): TumblerBuilder;
  onObjectNameChanged(body: string): TumblerBuilder;
  onOpacityChanged(body: string): TumblerBuilder;
  onPaddingChanged(body: string): TumblerBuilder;
  onPaletteChanged(body: string): TumblerBuilder;
  onPaletteCreated(body: string): TumblerBuilder;
  onParentChanged(body: string): TumblerBuilder;
  onRightInsetChanged(body: string): TumblerBuilder;
  onRightPaddingChanged(body: string): TumblerBuilder;
  onRotationChanged(body: string): TumblerBuilder;
  onScaleChanged(body: string): TumblerBuilder;
  onSmoothChanged(body: string): TumblerBuilder;
  onSpacingChanged(body: string): TumblerBuilder;
  onStateChanged(body: string): TumblerBuilder;
  onTopInsetChanged(body: string): TumblerBuilder;
  onTopPaddingChanged(body: string): TumblerBuilder;
  onTransformOriginChanged(body: string): TumblerBuilder;
  onVerticalPaddingChanged(body: string): TumblerBuilder;
  onVisibleChanged(body: string): TumblerBuilder;
  onVisibleChildrenChanged(body: string): TumblerBuilder;
  onVisibleItemCountChanged(body: string): TumblerBuilder;
  onVisualFocusChanged(body: string): TumblerBuilder;
  onWheelEnabledChanged(body: string): TumblerBuilder;
  onWidthChanged(body: string): TumblerBuilder;
  onWindowChanged(body: string): TumblerBuilder;
  onWrapChanged(body: string): TumblerBuilder;
  onXChanged(body: string): TumblerBuilder;
  onYChanged(body: string): TumblerBuilder;
  onZChanged(body: string): TumblerBuilder;
...
export namespace Tumbler {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('Tumbler', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('Tumbler', 'Flags', 'ItemAcceptsInputMethod');
  ...
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('Tumbler', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('Tumbler', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('Tumbler', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('Tumbler', 'ItemChange', 'ItemTransformHasChanged');
  }
