...
export interface SwitchDelegateBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): SwitchDelegateBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onCanceled(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onClicked(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onClipChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onDownChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onFontChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onIconChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onParentChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPressed(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onReleased(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onStateChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onTextChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onToggled(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onVisualPositionChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onXChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onYChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
  onZChanged(handler: DslSignalHandlerValue): SwitchDelegateBuilder;
...
export function SwitchDelegate(): SwitchDelegateBuilder {
  return createFluentBuilder(
    'SwitchDelegate',
    SWITCHDELEGATE_META,
  ) as unknown as SwitchDelegateBuilder;
}
