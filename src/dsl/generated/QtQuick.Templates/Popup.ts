...
export interface PopupBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): PopupBuilder;
  ...
  onAboutToHide(handler: DslSignalHandlerValue): PopupBuilder;
  onAboutToShow(handler: DslSignalHandlerValue): PopupBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onClipChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onClosePolicyChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onClosed(handler: DslSignalHandlerValue): PopupBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onDimChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onEnterChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onExitChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onFontChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onMarginsChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onModalChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onOpened(handler: DslSignalHandlerValue): PopupBuilder;
  onOpenedChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): PopupBuilder;
  onParentChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onPopupTypeChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onXChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onYChanged(handler: DslSignalHandlerValue): PopupBuilder;
  onZChanged(handler: DslSignalHandlerValue): PopupBuilder;
