...
export interface CheckBoxBuilder {
  ...
  onActionChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onCanceled(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onCheckStateChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onClicked(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onDownChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onFontChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onIconChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onNextCheckStateChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onPressAndHold(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onPressed(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onReleased(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onSpacingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onStateChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onTextChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onToggled(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onTristateChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): CheckBoxBuilder;
