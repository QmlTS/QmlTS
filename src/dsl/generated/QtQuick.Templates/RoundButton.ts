...
export interface RoundButtonBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): RoundButtonBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onCanceled(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onClicked(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onClipChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onDownChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onFlatChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onFontChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onIconChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onParentChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPressed(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onRadiusChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onReleased(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onStateChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onTextChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onToggled(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onXChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onYChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
  onZChanged(handler: DslSignalHandlerValue): RoundButtonBuilder;
