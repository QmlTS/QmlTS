...
export interface ToolSeparatorBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ToolSeparatorBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onXChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onYChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
  onZChanged(handler: DslSignalHandlerValue): ToolSeparatorBuilder;
