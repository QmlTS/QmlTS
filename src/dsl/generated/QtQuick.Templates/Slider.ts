...
export interface SliderBuilder {
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onFontChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onFromChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onHandleChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitHandleHeightChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onImplicitHandleWidthChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onLeftInsetChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onLiveChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onMoved(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onOrientationChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onPositionChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onSnapModeChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onStateChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onStepSizeChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onToChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onTouchDragThresholdChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onValueChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): SliderBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onVisualPositionChanged(handler: DslSignalHandlerValue): SliderBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): SliderBuilder;
