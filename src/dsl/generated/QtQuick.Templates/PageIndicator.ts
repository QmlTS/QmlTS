...
export interface PageIndicatorBuilder {
  ...
  onActiveFocusChanged(body: string): PageIndicatorBuilder;
  onActiveFocusOnTabChanged(body: string): PageIndicatorBuilder;
  onAntialiasingChanged(body: string): PageIndicatorBuilder;
  onAvailableHeightChanged(body: string): PageIndicatorBuilder;
  onAvailableWidthChanged(body: string): PageIndicatorBuilder;
  onBackgroundChanged(body: string): PageIndicatorBuilder;
  onBaselineOffsetChanged(body: string): PageIndicatorBuilder;
  onBottomInsetChanged(body: string): PageIndicatorBuilder;
  onBottomPaddingChanged(body: string): PageIndicatorBuilder;
  onChildrenChanged(body: string): PageIndicatorBuilder;
  onChildrenRectChanged(body: string): PageIndicatorBuilder;
  onClipChanged(body: string): PageIndicatorBuilder;
  onContainmentMaskChanged(body: string): PageIndicatorBuilder;
  onContentItemChanged(body: string): PageIndicatorBuilder;
  onCountChanged(body: string): PageIndicatorBuilder;
  onCurrentIndexChanged(body: string): PageIndicatorBuilder;
  onDelegateChanged(body: string): PageIndicatorBuilder;
  onEnabledChanged(body: string): PageIndicatorBuilder;
  onFocusChanged(body: string): PageIndicatorBuilder;
  onFocusPolicyChanged(body: string): PageIndicatorBuilder;
  onFocusReasonChanged(body: string): PageIndicatorBuilder;
  onFontChanged(body: string): PageIndicatorBuilder;
  onHeightChanged(body: string): PageIndicatorBuilder;
  onHorizontalPaddingChanged(body: string): PageIndicatorBuilder;
  onHoverEnabledChanged(body: string): PageIndicatorBuilder;
  onHoveredChanged(body: string): PageIndicatorBuilder;
  onImplicitBackgroundHeightChanged(body: string): PageIndicatorBuilder;
  onImplicitBackgroundWidthChanged(body: string): PageIndicatorBuilder;
  onImplicitContentHeightChanged(body: string): PageIndicatorBuilder;
  onImplicitContentWidthChanged(body: string): PageIndicatorBuilder;
  onImplicitHeightChanged(body: string): PageIndicatorBuilder;
  onImplicitWidthChanged(body: string): PageIndicatorBuilder;
  onInteractiveChanged(body: string): PageIndicatorBuilder;
  onLeftInsetChanged(body: string): PageIndicatorBuilder;
  onLeftPaddingChanged(body: string): PageIndicatorBuilder;
  onLocaleChanged(body: string): PageIndicatorBuilder;
  onMirroredChanged(body: string): PageIndicatorBuilder;
  onObjectNameChanged(body: string): PageIndicatorBuilder;
  onOpacityChanged(body: string): PageIndicatorBuilder;
  onPaddingChanged(body: string): PageIndicatorBuilder;
  onPaletteChanged(body: string): PageIndicatorBuilder;
  onPaletteCreated(body: string): PageIndicatorBuilder;
  onParentChanged(body: string): PageIndicatorBuilder;
  onRightInsetChanged(body: string): PageIndicatorBuilder;
  onRightPaddingChanged(body: string): PageIndicatorBuilder;
  onRotationChanged(body: string): PageIndicatorBuilder;
  onScaleChanged(body: string): PageIndicatorBuilder;
  onSmoothChanged(body: string): PageIndicatorBuilder;
  onSpacingChanged(body: string): PageIndicatorBuilder;
  onStateChanged(body: string): PageIndicatorBuilder;
  onTopInsetChanged(body: string): PageIndicatorBuilder;
  onTopPaddingChanged(body: string): PageIndicatorBuilder;
  onTransformOriginChanged(body: string): PageIndicatorBuilder;
  onVerticalPaddingChanged(body: string): PageIndicatorBuilder;
  onVisibleChanged(body: string): PageIndicatorBuilder;
  onVisibleChildrenChanged(body: string): PageIndicatorBuilder;
  onVisualFocusChanged(body: string): PageIndicatorBuilder;
  onWheelEnabledChanged(body: string): PageIndicatorBuilder;
  onWidthChanged(body: string): PageIndicatorBuilder;
  onWindowChanged(body: string): PageIndicatorBuilder;
  onXChanged(body: string): PageIndicatorBuilder;
  onYChanged(body: string): PageIndicatorBuilder;
  onZChanged(body: string): PageIndicatorBuilder;
...
export function PageIndicator(): PageIndicatorBuilder {
  return createFluentBuilder('PageIndicator', PAGEINDICATOR_META) as unknown as PageIndicatorBuilder;
}

export namespace PageIndicator {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('PageIndicator', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('PageIndicator', 'Flags', 'ItemAcceptsInputMethod');
    ...
    export const ItemObservesViewport = createEnumToken('PageIndicator', 'Flags', 'ItemObservesViewport');
  }
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('PageIndicator', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('PageIndicator', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('PageIndicator', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('PageIndicator', 'ItemChange', 'ItemTransformHasChanged');
  }
