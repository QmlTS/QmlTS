...
export interface TextFieldBuilder {
  ...
  onAcceptableInputChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onAccepted(handler: DslSignalHandlerValue): TextFieldBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onActiveFocusOnPressChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onAutoScrollChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCanPasteChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCanRedoChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCanUndoChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onColorChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onContentSizeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCursorDelegateChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCursorPositionChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCursorRectangleChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onCursorVisibleChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onDisplayTextChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onEchoModeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onEditingFinished(handler: DslSignalHandlerValue): TextFieldBuilder;
  onEffectiveHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitHeightChanged3(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onImplicitWidthChanged3(handler: DslSignalHandlerValue): TextFieldBuilder;
  onInputMaskChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onInputMethodComposingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onInputMethodHintsChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onMaximumLengthChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onMouseSelectionModeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onOverwriteModeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onPasswordCharacterChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPasswordMaskDelayChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPersistentSelectionChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPlaceholderTextChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPlaceholderTextColorChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPreeditTextChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): TextFieldBuilder;
  onPressed(handler: DslSignalHandlerValue): TextFieldBuilder;
  onReadOnlyChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onReleased(handler: DslSignalHandlerValue): TextFieldBuilder;
  onRenderTypeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onSelectByMouseChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onSelectedTextChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onSelectedTextColorChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onSelectionColorChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onSelectionEndChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onSelectionStartChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onTextChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onTextEdited(handler: DslSignalHandlerValue): TextFieldBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onValidatorChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
  ...
  onWrapModeChanged(handler: DslSignalHandlerValue): TextFieldBuilder;
