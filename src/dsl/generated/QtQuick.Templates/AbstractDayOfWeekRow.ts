...
export interface AbstractDayOfWeekRowBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): AbstractDayOfWeekRowBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onClipChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onFontChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onParentChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onStateChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onXChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onYChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
  onZChanged(handler: DslSignalHandlerValue): AbstractDayOfWeekRowBuilder;
...
export function AbstractDayOfWeekRow(): AbstractDayOfWeekRowBuilder {
  return createFluentBuilder(
    ...
    ABSTRACTDAYOFWEEKROW_META,
  ) as unknown as AbstractDayOfWeekRowBuilder;
}
