...
export interface StackViewBuilder {
  ...
  onActiveFocusChanged(body: string): StackViewBuilder;
  onActiveFocusOnTabChanged(body: string): StackViewBuilder;
  onAntialiasingChanged(body: string): StackViewBuilder;
  onAvailableHeightChanged(body: string): StackViewBuilder;
  onAvailableWidthChanged(body: string): StackViewBuilder;
  onBackgroundChanged(body: string): StackViewBuilder;
  onBaselineOffsetChanged(body: string): StackViewBuilder;
  onBottomInsetChanged(body: string): StackViewBuilder;
  onBottomPaddingChanged(body: string): StackViewBuilder;
  onBusyChanged(body: string): StackViewBuilder;
  onChildrenChanged(body: string): StackViewBuilder;
  onChildrenRectChanged(body: string): StackViewBuilder;
  onClipChanged(body: string): StackViewBuilder;
  onContainmentMaskChanged(body: string): StackViewBuilder;
  onContentItemChanged(body: string): StackViewBuilder;
  onCurrentItemChanged(body: string): StackViewBuilder;
  onDepthChanged(body: string): StackViewBuilder;
  onEmptyChanged(body: string): StackViewBuilder;
  onEnabledChanged(body: string): StackViewBuilder;
  onFocusChanged(body: string): StackViewBuilder;
  onFocusPolicyChanged(body: string): StackViewBuilder;
  onFocusReasonChanged(body: string): StackViewBuilder;
  onFontChanged(body: string): StackViewBuilder;
  onHeightChanged(body: string): StackViewBuilder;
  onHorizontalPaddingChanged(body: string): StackViewBuilder;
  onHoverEnabledChanged(body: string): StackViewBuilder;
  onHoveredChanged(body: string): StackViewBuilder;
  onImplicitBackgroundHeightChanged(body: string): StackViewBuilder;
  onImplicitBackgroundWidthChanged(body: string): StackViewBuilder;
  onImplicitContentHeightChanged(body: string): StackViewBuilder;
  onImplicitContentWidthChanged(body: string): StackViewBuilder;
  onImplicitHeightChanged(body: string): StackViewBuilder;
  onImplicitWidthChanged(body: string): StackViewBuilder;
  onLeftInsetChanged(body: string): StackViewBuilder;
  onLeftPaddingChanged(body: string): StackViewBuilder;
  onLocaleChanged(body: string): StackViewBuilder;
  onMirroredChanged(body: string): StackViewBuilder;
  onObjectNameChanged(body: string): StackViewBuilder;
  onOpacityChanged(body: string): StackViewBuilder;
  onPaddingChanged(body: string): StackViewBuilder;
  onPaletteChanged(body: string): StackViewBuilder;
  onPaletteCreated(body: string): StackViewBuilder;
  onParentChanged(body: string): StackViewBuilder;
  onPopEnterChanged(body: string): StackViewBuilder;
  onPopExitChanged(body: string): StackViewBuilder;
  onPushEnterChanged(body: string): StackViewBuilder;
  onPushExitChanged(body: string): StackViewBuilder;
  onReplaceEnterChanged(body: string): StackViewBuilder;
  onReplaceExitChanged(body: string): StackViewBuilder;
  onRightInsetChanged(body: string): StackViewBuilder;
  onRightPaddingChanged(body: string): StackViewBuilder;
  onRotationChanged(body: string): StackViewBuilder;
  onScaleChanged(body: string): StackViewBuilder;
  onSmoothChanged(body: string): StackViewBuilder;
  onSpacingChanged(body: string): StackViewBuilder;
  onStateChanged(body: string): StackViewBuilder;
  onTopInsetChanged(body: string): StackViewBuilder;
  onTopPaddingChanged(body: string): StackViewBuilder;
  onTransformOriginChanged(body: string): StackViewBuilder;
  onVerticalPaddingChanged(body: string): StackViewBuilder;
  onVisibleChanged(body: string): StackViewBuilder;
  onVisibleChildrenChanged(body: string): StackViewBuilder;
  onVisualFocusChanged(body: string): StackViewBuilder;
  onWheelEnabledChanged(body: string): StackViewBuilder;
  onWidthChanged(body: string): StackViewBuilder;
  onWindowChanged(body: string): StackViewBuilder;
  onXChanged(body: string): StackViewBuilder;
  onYChanged(body: string): StackViewBuilder;
  onZChanged(body: string): StackViewBuilder;
...
export namespace StackView {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('StackView', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('StackView', 'Flags', 'ItemAcceptsInputMethod');
    ...
    export const ItemObservesViewport = createEnumToken('StackView', 'Flags', 'ItemObservesViewport');
  }
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('StackView', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('StackView', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('StackView', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('StackView', 'ItemChange', 'ItemTransformHasChanged');
  }
