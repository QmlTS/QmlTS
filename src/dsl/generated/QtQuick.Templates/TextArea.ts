...
export interface TextAreaBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TextAreaBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onActiveFocusOnPressChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onBaseUrlChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCanPasteChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCanRedoChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCanUndoChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onColorChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onContentSizeChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCursorDelegateChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCursorPositionChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCursorRectangleChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onCursorVisibleChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onEditingFinished(handler: DslSignalHandlerValue): TextAreaBuilder;
  onEffectiveHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onFontChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitHeightChanged3(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onImplicitWidthChanged3(handler: DslSignalHandlerValue): TextAreaBuilder;
  onInputMethodComposingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onInputMethodHintsChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onLineCountChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onLinkActivated(handler: DslSignalHandlerValue): TextAreaBuilder;
  onLinkHovered(handler: DslSignalHandlerValue): TextAreaBuilder;
  onMouseSelectionModeChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onOverwriteModeChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TextAreaBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPersistentSelectionChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPlaceholderTextChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPlaceholderTextColorChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPreeditTextChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): TextAreaBuilder;
  onPressed(handler: DslSignalHandlerValue): TextAreaBuilder;
  onReadOnlyChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onReleased(handler: DslSignalHandlerValue): TextAreaBuilder;
  onRenderTypeChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectByKeyboardChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectByMouseChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectedTextChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectedTextColorChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectionColorChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectionEndChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSelectionStartChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTabStopDistanceChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTextChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTextEdited(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTextFormatChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTextMarginChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onWrapModeChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onXChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onYChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
  onZChanged(handler: DslSignalHandlerValue): TextAreaBuilder;
