...
export interface AbstractWeekNumberColumnBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): AbstractWeekNumberColumnBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onClipChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onFontChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onImplicitBackgroundHeightChanged(
    handler: DslSignalHandlerValue,
  ): AbstractWeekNumberColumnBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onMonthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onParentChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onStateChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onXChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onYChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onYearChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
  onZChanged(handler: DslSignalHandlerValue): AbstractWeekNumberColumnBuilder;
