...
export interface ComboBoxBuilder {
  ...
  onAcceptableInputChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onAccepted(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onActivated(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onCountChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onCurrentTextChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onCurrentValueChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onDelegateModelChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onDisplayTextChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onDownChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onEditTextChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onEditableChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onFlatChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHighlighted(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHighlightedIndexChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitContentWidthPolicyChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onInputMethodComposingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onInputMethodHintsChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onModelChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onPopupChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onSelectTextByMouseChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onTextRoleChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onValidatorChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onValueRoleChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ComboBoxBuilder;
