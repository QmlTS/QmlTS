...
export interface RadioDelegateBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): RadioDelegateBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onCanceled(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onClicked(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onClipChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onDownChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onFontChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onIconChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onParentChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPressed(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onReleased(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onStateChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onTextChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onToggled(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onXChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onYChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
  onZChanged(handler: DslSignalHandlerValue): RadioDelegateBuilder;
