...
export interface TableViewDelegateBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TableViewDelegateBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onCanceled(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onClicked(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onCurrentChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onDownChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onEditingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onFontChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onIconChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPressed(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onReleased(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onSelectedChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onTableViewChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onTextChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onToggled(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onXChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onYChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
  onZChanged(handler: DslSignalHandlerValue): TableViewDelegateBuilder;
...
export function TableViewDelegate(): TableViewDelegateBuilder {
  return createFluentBuilder(
    'TableViewDelegate',
    TABLEVIEWDELEGATE_META,
  ) as unknown as TableViewDelegateBuilder;
}
