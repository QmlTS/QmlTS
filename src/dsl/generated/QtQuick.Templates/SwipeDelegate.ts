...
export interface SwipeDelegateBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): SwipeDelegateBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onCanceled(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onClicked(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onClipChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onDownChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onFontChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onIconChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onParentChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPressed(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onReleased(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onStateChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onTextChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onToggled(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onXChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onYChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
  onZChanged(handler: DslSignalHandlerValue): SwipeDelegateBuilder;
