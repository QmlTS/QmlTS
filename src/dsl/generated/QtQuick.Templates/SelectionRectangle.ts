...
export interface SelectionRectangleBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): SelectionRectangleBuilder;
  ...
  onActiveChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onBottomRightHandleChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onClipChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onDraggingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onFontChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onParentChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onSelectionModeChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onStateChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onTargetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onTopLeftHandleChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onXChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onYChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
  onZChanged(handler: DslSignalHandlerValue): SelectionRectangleBuilder;
