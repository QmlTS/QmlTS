...
export interface ToolButtonBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ToolButtonBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onCanceled(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onClicked(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onDownChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onFlatChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onIconChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPressed(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onReleased(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onTextChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onToggled(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onXChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onYChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
  onZChanged(handler: DslSignalHandlerValue): ToolButtonBuilder;
