...
export interface ScrollBarBuilder {
  ...
  locale(value: string): ScrollBarBuilder;
  ...
  onActiveChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onInteractiveChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onMinimumSizeChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onOrientationChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onPolicyChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onSizeChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onSnapModeChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onStepSizeChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onVisualPositionChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onVisualSizeChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ScrollBarBuilder;
