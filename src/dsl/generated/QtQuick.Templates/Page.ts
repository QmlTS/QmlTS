...
export interface PageBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): PageBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): PageBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): PageBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): PageBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): PageBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): PageBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): PageBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): PageBuilder;
  onClipChanged(handler: DslSignalHandlerValue): PageBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): PageBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): PageBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): PageBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): PageBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): PageBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): PageBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): PageBuilder;
  onFontChanged(handler: DslSignalHandlerValue): PageBuilder;
  onFooterChanged(handler: DslSignalHandlerValue): PageBuilder;
  onHeaderChanged(handler: DslSignalHandlerValue): PageBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): PageBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitFooterHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitFooterWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitHeaderHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitHeaderWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): PageBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): PageBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): PageBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): PageBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): PageBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): PageBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): PageBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): PageBuilder;
  onParentChanged(handler: DslSignalHandlerValue): PageBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): PageBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): PageBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): PageBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): PageBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onStateChanged(handler: DslSignalHandlerValue): PageBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): PageBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): PageBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): PageBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): PageBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): PageBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): PageBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): PageBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): PageBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): PageBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): PageBuilder;
  onXChanged(handler: DslSignalHandlerValue): PageBuilder;
  onYChanged(handler: DslSignalHandlerValue): PageBuilder;
  onZChanged(handler: DslSignalHandlerValue): PageBuilder;
