...
export interface DelayButtonBuilder {
  ...
  onActionChanged(body: string): DelayButtonBuilder;
  onActivated(body: string): DelayButtonBuilder;
  ...
  onAutoExclusiveChanged(body: string): DelayButtonBuilder;
  onAutoRepeatChanged(body: string): DelayButtonBuilder;
  onAutoRepeatDelayChanged(body: string): DelayButtonBuilder;
  onAutoRepeatIntervalChanged(body: string): DelayButtonBuilder;
  onAvailableHeightChanged(body: string): DelayButtonBuilder;
  onAvailableWidthChanged(body: string): DelayButtonBuilder;
  onBackgroundChanged(body: string): DelayButtonBuilder;
  onBaselineOffsetChanged(body: string): DelayButtonBuilder;
  onBottomInsetChanged(body: string): DelayButtonBuilder;
  onBottomPaddingChanged(body: string): DelayButtonBuilder;
  onCanceled(body: string): DelayButtonBuilder;
  onCheckableChanged(body: string): DelayButtonBuilder;
  onCheckedChanged(body: string): DelayButtonBuilder;
  onChildrenChanged(body: string): DelayButtonBuilder;
  onChildrenRectChanged(body: string): DelayButtonBuilder;
  onClicked(body: string): DelayButtonBuilder;
  onClipChanged(body: string): DelayButtonBuilder;
  onContainmentMaskChanged(body: string): DelayButtonBuilder;
  onContentItemChanged(body: string): DelayButtonBuilder;
  onDelayChanged(body: string): DelayButtonBuilder;
  onDisplayChanged(body: string): DelayButtonBuilder;
  onDoubleClicked(body: string): DelayButtonBuilder;
  onDownChanged(body: string): DelayButtonBuilder;
  ...
  onFocusReasonChanged(body: string): DelayButtonBuilder;
  onFontChanged(body: string): DelayButtonBuilder;
  onHeightChanged(body: string): DelayButtonBuilder;
  onHorizontalPaddingChanged(body: string): DelayButtonBuilder;
  onHoverEnabledChanged(body: string): DelayButtonBuilder;
  onHoveredChanged(body: string): DelayButtonBuilder;
  onIconChanged(body: string): DelayButtonBuilder;
  onImplicitBackgroundHeightChanged(body: string): DelayButtonBuilder;
  onImplicitBackgroundWidthChanged(body: string): DelayButtonBuilder;
  onImplicitContentHeightChanged(body: string): DelayButtonBuilder;
  onImplicitContentWidthChanged(body: string): DelayButtonBuilder;
  onImplicitHeightChanged(body: string): DelayButtonBuilder;
  onImplicitIndicatorHeightChanged(body: string): DelayButtonBuilder;
  onImplicitIndicatorWidthChanged(body: string): DelayButtonBuilder;
  onImplicitWidthChanged(body: string): DelayButtonBuilder;
  onIndicatorChanged(body: string): DelayButtonBuilder;
  onLeftInsetChanged(body: string): DelayButtonBuilder;
  onLeftPaddingChanged(body: string): DelayButtonBuilder;
  onLocaleChanged(body: string): DelayButtonBuilder;
  onMirroredChanged(body: string): DelayButtonBuilder;
  onObjectNameChanged(body: string): DelayButtonBuilder;
  onOpacityChanged(body: string): DelayButtonBuilder;
  onPaddingChanged(body: string): DelayButtonBuilder;
  ...
  onPressAndHold(body: string): DelayButtonBuilder;
  onPressXChanged(body: string): DelayButtonBuilder;
  onPressYChanged(body: string): DelayButtonBuilder;
  onPressed(body: string): DelayButtonBuilder;
  onPressedChanged(body: string): DelayButtonBuilder;
  onProgressChanged(body: string): DelayButtonBuilder;
  onReleased(body: string): DelayButtonBuilder;
  onRightInsetChanged(body: string): DelayButtonBuilder;
  onRightPaddingChanged(body: string): DelayButtonBuilder;
  ...
  onSpacingChanged(body: string): DelayButtonBuilder;
  onStateChanged(body: string): DelayButtonBuilder;
  onTextChanged(body: string): DelayButtonBuilder;
  onToggled(body: string): DelayButtonBuilder;
  onTopInsetChanged(body: string): DelayButtonBuilder;
  onTopPaddingChanged(body: string): DelayButtonBuilder;
  onTransformOriginChanged(body: string): DelayButtonBuilder;
  onTransitionChanged(body: string): DelayButtonBuilder;
  onVerticalPaddingChanged(body: string): DelayButtonBuilder;
  onVisibleChanged(body: string): DelayButtonBuilder;
  onVisibleChildrenChanged(body: string): DelayButtonBuilder;
  onVisualFocusChanged(body: string): DelayButtonBuilder;
  onWheelEnabledChanged(body: string): DelayButtonBuilder;
