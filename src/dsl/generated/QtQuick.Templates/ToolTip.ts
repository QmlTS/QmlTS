...
export interface ToolTipBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ToolTipBuilder;
  ...
  onAboutToHide(handler: DslSignalHandlerValue): ToolTipBuilder;
  onAboutToShow(handler: DslSignalHandlerValue): ToolTipBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onClosePolicyChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onClosed(handler: DslSignalHandlerValue): ToolTipBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onDelayChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onDimChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onEnterChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onExitChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onMarginsChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onModalChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onOpened(handler: DslSignalHandlerValue): ToolTipBuilder;
  onOpenedChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ToolTipBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onPopupTypeChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onTextChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onTimeoutChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onXChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onYChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
  onZChanged(handler: DslSignalHandlerValue): ToolTipBuilder;
