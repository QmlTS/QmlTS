...
const ACTIONGROUP_META: TypeMetadata = {
  typeName: 'ActionGroup',
  properties: [
    { name: 'checkedAction', hasValue: true, hasBinding: true },
    { name: 'enabled', hasValue: true, hasBinding: true },
    { name: 'exclusive', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onActionsChanged', paramCount: 0 },
    { handlerName: 'onCheckedActionChanged', paramCount: 0 },
...
export function ActionGroup(): ActionGroupBuilder {
  return createFluentBuilder('ActionGroup', ACTIONGROUP_META) as unknown as ActionGroupBuilder;
}
