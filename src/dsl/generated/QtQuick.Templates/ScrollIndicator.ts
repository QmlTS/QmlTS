...
export interface ScrollIndicatorBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ScrollIndicatorBuilder;
  ...
  onActiveChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onMinimumSizeChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onSizeChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVisualPositionChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onVisualSizeChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onXChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onYChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
  onZChanged(handler: DslSignalHandlerValue): ScrollIndicatorBuilder;
