...
export interface MenuBarItemBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): MenuBarItemBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onCanceled(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onClicked(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onDownChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onFontChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onIconChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onMenuBarChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onMenuChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPressed(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onReleased(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onTextChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onToggled(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onTriggered(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onXChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onYChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
  onZChanged(handler: DslSignalHandlerValue): MenuBarItemBuilder;
