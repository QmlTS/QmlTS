...
export interface SplitViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): SplitViewBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onCountChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onFontChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onHandleChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): SplitViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onResizingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): SplitViewBuilder;
