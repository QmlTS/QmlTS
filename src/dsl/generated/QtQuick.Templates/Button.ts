...
export interface ButtonBuilder {
  ...
  onActionChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onCanceled(handler: DslSignalHandlerValue): ButtonBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onClicked(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onContentItemChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): ButtonBuilder;
  onDownChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onFlatChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onIconChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onPressAndHold(handler: DslSignalHandlerValue): ButtonBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onPressed(handler: DslSignalHandlerValue): ButtonBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onReleased(handler: DslSignalHandlerValue): ButtonBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onSpacingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onTextChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onToggled(handler: DslSignalHandlerValue): ButtonBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): ButtonBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ButtonBuilder;
