...
export interface TabButtonBuilder {
  ...
  onActionChanged(body: string): TabButtonBuilder;
  onActiveFocusChanged(body: string): TabButtonBuilder;
  onActiveFocusOnTabChanged(body: string): TabButtonBuilder;
  onAntialiasingChanged(body: string): TabButtonBuilder;
  onAutoExclusiveChanged(body: string): TabButtonBuilder;
  onAutoRepeatChanged(body: string): TabButtonBuilder;
  onAutoRepeatDelayChanged(body: string): TabButtonBuilder;
  onAutoRepeatIntervalChanged(body: string): TabButtonBuilder;
  onAvailableHeightChanged(body: string): TabButtonBuilder;
  onAvailableWidthChanged(body: string): TabButtonBuilder;
  onBackgroundChanged(body: string): TabButtonBuilder;
  onBaselineOffsetChanged(body: string): TabButtonBuilder;
  onBottomInsetChanged(body: string): TabButtonBuilder;
  onBottomPaddingChanged(body: string): TabButtonBuilder;
  onCanceled(body: string): TabButtonBuilder;
  onCheckableChanged(body: string): TabButtonBuilder;
  onCheckedChanged(body: string): TabButtonBuilder;
  onChildrenChanged(body: string): TabButtonBuilder;
  onChildrenRectChanged(body: string): TabButtonBuilder;
  onClicked(body: string): TabButtonBuilder;
  onClipChanged(body: string): TabButtonBuilder;
  onContainmentMaskChanged(body: string): TabButtonBuilder;
  onContentItemChanged(body: string): TabButtonBuilder;
  onDisplayChanged(body: string): TabButtonBuilder;
  onDoubleClicked(body: string): TabButtonBuilder;
  onDownChanged(body: string): TabButtonBuilder;
  onEnabledChanged(body: string): TabButtonBuilder;
  onFocusChanged(body: string): TabButtonBuilder;
  onFocusPolicyChanged(body: string): TabButtonBuilder;
  onFocusReasonChanged(body: string): TabButtonBuilder;
  onFontChanged(body: string): TabButtonBuilder;
  onHeightChanged(body: string): TabButtonBuilder;
  onHorizontalPaddingChanged(body: string): TabButtonBuilder;
  onHoverEnabledChanged(body: string): TabButtonBuilder;
  onHoveredChanged(body: string): TabButtonBuilder;
  onIconChanged(body: string): TabButtonBuilder;
  onImplicitBackgroundHeightChanged(body: string): TabButtonBuilder;
  onImplicitBackgroundWidthChanged(body: string): TabButtonBuilder;
  onImplicitContentHeightChanged(body: string): TabButtonBuilder;
  onImplicitContentWidthChanged(body: string): TabButtonBuilder;
  onImplicitHeightChanged(body: string): TabButtonBuilder;
  onImplicitIndicatorHeightChanged(body: string): TabButtonBuilder;
  onImplicitIndicatorWidthChanged(body: string): TabButtonBuilder;
  onImplicitWidthChanged(body: string): TabButtonBuilder;
  onIndicatorChanged(body: string): TabButtonBuilder;
  onLeftInsetChanged(body: string): TabButtonBuilder;
  onLeftPaddingChanged(body: string): TabButtonBuilder;
  onLocaleChanged(body: string): TabButtonBuilder;
  onMirroredChanged(body: string): TabButtonBuilder;
  onObjectNameChanged(body: string): TabButtonBuilder;
  onOpacityChanged(body: string): TabButtonBuilder;
  onPaddingChanged(body: string): TabButtonBuilder;
  onPaletteChanged(body: string): TabButtonBuilder;
  onPaletteCreated(body: string): TabButtonBuilder;
  onParentChanged(body: string): TabButtonBuilder;
  onPressAndHold(body: string): TabButtonBuilder;
  onPressXChanged(body: string): TabButtonBuilder;
  onPressYChanged(body: string): TabButtonBuilder;
  onPressed(body: string): TabButtonBuilder;
  onPressedChanged(body: string): TabButtonBuilder;
  onReleased(body: string): TabButtonBuilder;
  onRightInsetChanged(body: string): TabButtonBuilder;
  onRightPaddingChanged(body: string): TabButtonBuilder;
  onRotationChanged(body: string): TabButtonBuilder;
  onScaleChanged(body: string): TabButtonBuilder;
  onSmoothChanged(body: string): TabButtonBuilder;
  onSpacingChanged(body: string): TabButtonBuilder;
  onStateChanged(body: string): TabButtonBuilder;
  onTextChanged(body: string): TabButtonBuilder;
  onToggled(body: string): TabButtonBuilder;
  onTopInsetChanged(body: string): TabButtonBuilder;
  onTopPaddingChanged(body: string): TabButtonBuilder;
  onTransformOriginChanged(body: string): TabButtonBuilder;
  onVerticalPaddingChanged(body: string): TabButtonBuilder;
  onVisibleChanged(body: string): TabButtonBuilder;
  onVisibleChildrenChanged(body: string): TabButtonBuilder;
  onVisualFocusChanged(body: string): TabButtonBuilder;
  onWheelEnabledChanged(body: string): TabButtonBuilder;
  onWidthChanged(body: string): TabButtonBuilder;
  onWindowChanged(body: string): TabButtonBuilder;
  onXChanged(body: string): TabButtonBuilder;
  onYChanged(body: string): TabButtonBuilder;
  onZChanged(body: string): TabButtonBuilder;
...
export namespace TabButton {
  ...
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('TabButton', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('TabButton', 'Flags', 'ItemAcceptsInputMethod');
    ...
    export const ItemObservesViewport = createEnumToken('TabButton', 'Flags', 'ItemObservesViewport');
  }
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('TabButton', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('TabButton', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('TabButton', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('TabButton', 'ItemChange', 'ItemTransformHasChanged');
  }
