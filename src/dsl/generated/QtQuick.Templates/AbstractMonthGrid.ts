...
export interface AbstractMonthGridBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): AbstractMonthGridBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onClicked(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onClipChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onFontChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onMonthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onParentChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onPressed(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onReleased(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onStateChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onXChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onYChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onYearChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
  onZChanged(handler: DslSignalHandlerValue): AbstractMonthGridBuilder;
