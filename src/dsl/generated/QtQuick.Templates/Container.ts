...
export interface ContainerBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ContainerBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onCountChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ContainerBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onXChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onYChanged(handler: DslSignalHandlerValue): ContainerBuilder;
  onZChanged(handler: DslSignalHandlerValue): ContainerBuilder;
