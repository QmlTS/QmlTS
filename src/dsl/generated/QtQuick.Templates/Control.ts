...
export interface ControlBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ControlBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ControlBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onXChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onYChanged(handler: DslSignalHandlerValue): ControlBuilder;
  onZChanged(handler: DslSignalHandlerValue): ControlBuilder;
