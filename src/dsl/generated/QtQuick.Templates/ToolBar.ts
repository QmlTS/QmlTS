...
export interface ToolBarBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ToolBarBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ToolBarBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onXChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onYChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
  onZChanged(handler: DslSignalHandlerValue): ToolBarBuilder;
