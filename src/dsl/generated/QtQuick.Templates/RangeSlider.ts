...
export interface RangeSliderBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): RangeSliderBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onClipChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onFontChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onFromChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onLiveChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onParentChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onSnapModeChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onStateChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onStepSizeChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onToChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onTouchDragThresholdChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onXChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onYChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
  onZChanged(handler: DslSignalHandlerValue): RangeSliderBuilder;
