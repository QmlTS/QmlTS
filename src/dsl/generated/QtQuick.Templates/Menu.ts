...
export interface MenuBuilder {
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onCascadeChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onClosePolicyChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onClosed(handler: DslSignalHandlerValue): MenuBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onCountChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onDimChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onEnterChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onExitChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onFontChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onIconChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onMarginsChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onModalChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onOpened(handler: DslSignalHandlerValue): MenuBuilder;
  onOpenedChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onOverlapChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MenuBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onPopupTypeChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onXChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onYChanged(handler: DslSignalHandlerValue): MenuBuilder;
  onZChanged(handler: DslSignalHandlerValue): MenuBuilder;
