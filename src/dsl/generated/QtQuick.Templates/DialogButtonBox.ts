...
export interface DialogButtonBoxBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): DialogButtonBoxBuilder;
  ...
  onAccepted(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onAlignmentChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onApplied(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onButtonLayoutChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onClicked(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onClipChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onCountChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onDefaultButtonChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onDefaultStandardButtonChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onDiscarded(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onFontChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onHelpRequested(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onParentChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onRejected(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onReset(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onStandardButtonsChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onStateChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onXChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onYChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
  onZChanged(handler: DslSignalHandlerValue): DialogButtonBoxBuilder;
...
export function DialogButtonBox(): DialogButtonBoxBuilder {
  return createFluentBuilder(
    'DialogButtonBox',
    DIALOGBUTTONBOX_META,
  ) as unknown as DialogButtonBoxBuilder;
}
