...
export interface MenuBarBuilder {
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onCountChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onFontChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onMenusChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MenuBarBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onXChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onYChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
  onZChanged(handler: DslSignalHandlerValue): MenuBarBuilder;
