...
export interface HeaderViewDelegateBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): HeaderViewDelegateBuilder;
  ...
  onActionChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAutoExclusiveChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAutoRepeatChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAutoRepeatDelayChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAutoRepeatIntervalChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onCanceled(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onCheckableChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onCheckedChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onClicked(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onClipChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onCurrentChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onDisplayChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onDownChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onEditingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onFontChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHeaderViewChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHighlightedChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onIconChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitIndicatorHeightChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitIndicatorWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onIndicatorChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onModelChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onParentChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPressXChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPressYChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPressed(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onReleased(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onSelectedChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onStateChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onTableViewChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onTextChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onToggled(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onXChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onYChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
  onZChanged(handler: DslSignalHandlerValue): HeaderViewDelegateBuilder;
