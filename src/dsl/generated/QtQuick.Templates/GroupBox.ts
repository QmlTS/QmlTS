...
export interface GroupBoxBuilder {
  ...
  onAvailableHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onContentChildrenChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onFocusReasonChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onFontChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitLabelHeightChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitLabelWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onLabelChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onRightInsetChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onSpacingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onStateChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  ...
  onVisualFocusChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): GroupBoxBuilder;
