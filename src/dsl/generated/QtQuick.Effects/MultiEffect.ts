...
export interface MultiEffectBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): MultiEffectBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onAutoPaddingEnabledChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBlurChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBlurEnabledChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBlurMaxChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBlurMultiplierChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onBrightnessChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onColorizationChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onColorizationColorChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onContrastChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onFragmentShaderChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onHasProxySourceChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onItemRectChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onItemSizeChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskEnabledChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskInvertedChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskSourceChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskSpreadAtMaxChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskSpreadAtMinChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskThresholdMaxChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onMaskThresholdMinChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onPaddingRectChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onSaturationChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShaderChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowBlurChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowColorChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowEnabledChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowHorizontalOffsetChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowOpacityChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowScaleChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onShadowVerticalOffsetChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onVertexShaderChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onXChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onYChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
  onZChanged(handler: DslSignalHandlerValue): MultiEffectBuilder;
