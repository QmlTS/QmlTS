...
const OPACITYANIMATOR_META: TypeMetadata = {
  typeName: 'OpacityAnimator',
  properties: [
...
export function OpacityAnimator(): OpacityAnimatorBuilder {
  return createFluentBuilder('OpacityAnimator', OPACITYANIMATOR_META) as unknown as OpacityAnimatorBuilder;
}
