...
const SCALEANIMATOR_META: TypeMetadata = {
  typeName: 'ScaleAnimator',
  properties: [
...
export function ScaleAnimator(): ScaleAnimatorBuilder {
  return createFluentBuilder('ScaleAnimator', SCALEANIMATOR_META) as unknown as ScaleAnimatorBuilder;
}
