...
const PROPERTYCHANGES_META: TypeMetadata = {
  typeName: 'PropertyChanges',
  properties: [
    { name: 'explicit', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'restoreEntryValues', hasValue: true, hasBinding: true },
    { name: 'target', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onIsExplicitChanged', paramCount: 0 },
    { handlerName: 'onObjectChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onRestoreEntryValuesChanged', paramCount: 0 },
  ],
  grouped: [
  ],
  attached: [
...
export function PropertyChanges(): PropertyChangesBuilder {
  return createFluentBuilder('PropertyChanges', PROPERTYCHANGES_META) as unknown as PropertyChangesBuilder;
}
