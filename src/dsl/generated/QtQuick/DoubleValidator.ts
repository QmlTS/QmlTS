...
export interface DoubleValidatorBuilder {
  ...
  notation(value: QmlEnumToken): DoubleValidatorBuilder;
...
const DOUBLEVALIDATOR_META: TypeMetadata = {
  typeName: 'DoubleValidator',
  properties: [
    { name: 'bottom', hasValue: true, hasBinding: true },
    { name: 'decimals', hasValue: true, hasBinding: true },
    { name: 'locale', hasValue: true, hasBinding: true },
    { name: 'notation', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onDecimalsChanged', paramCount: 1 },
    { handlerName: 'onLocaleNameChanged', paramCount: 0 },
    { handlerName: 'onNotationChanged', paramCount: 1 },
...
export function DoubleValidator(): DoubleValidatorBuilder {
  return createFluentBuilder('DoubleValidator', DOUBLEVALIDATOR_META) as unknown as DoubleValidatorBuilder;
}

export namespace DoubleValidator {
  export namespace Notation {
    export const StandardNotation = createEnumToken('DoubleValidator', 'Notation', 'StandardNotation');
    export const ScientificNotation = createEnumToken('DoubleValidator', 'Notation', 'ScientificNotation');
  }
