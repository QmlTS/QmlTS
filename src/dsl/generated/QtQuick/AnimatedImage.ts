...
export interface AnimatedImageBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): AnimatedImageBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onAsynchronousChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onAutoTransformChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onCacheChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onClipChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onColorSpaceChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onCurrentFrameChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onFillModeChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onFrameChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onFrameCountChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onMipmapChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onMirrorChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onMirrorVerticallyChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onPaintedGeometryChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onParentChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onPausedChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onPlayingChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onProgressChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onRetainWhileLoadingChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onSourceClipRectChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onSourceSizeChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onSpeedChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onStateChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onStatusChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onXChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onYChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
  onZChanged(handler: DslSignalHandlerValue): AnimatedImageBuilder;
...
export function AnimatedImage(): AnimatedImageBuilder {
  return createFluentBuilder(
    'AnimatedImage',
    ANIMATEDIMAGE_META,
  ) as unknown as AnimatedImageBuilder;
}
