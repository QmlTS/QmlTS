...
const TRANSITION_META: TypeMetadata = {
  typeName: 'Transition',
  properties: [
    { name: 'enabled', hasValue: true, hasBinding: true },
    { name: 'from', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'reversible', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onReversibleChanged', paramCount: 0 },
...
export function Transition(): TransitionBuilder {
  return createFluentBuilder('Transition', TRANSITION_META) as unknown as TransitionBuilder;
}
