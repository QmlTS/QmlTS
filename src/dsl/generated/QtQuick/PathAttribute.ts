...
const PATHATTRIBUTE_META: TypeMetadata = {
  typeName: 'PathAttribute',
  properties: [
...
export function PathAttribute(): PathAttributeBuilder {
  return createFluentBuilder('PathAttribute', PATHATTRIBUTE_META) as unknown as PathAttributeBuilder;
}
