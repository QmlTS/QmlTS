...
const PATHCUBIC_META: TypeMetadata = {
  typeName: 'PathCubic',
  properties: [
    { name: 'control1X', hasValue: true, hasBinding: true },
    { name: 'control1Y', hasValue: true, hasBinding: true },
    { name: 'control2X', hasValue: true, hasBinding: true },
    { name: 'control2Y', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'relativeControl1X', hasValue: true, hasBinding: true },
    { name: 'relativeControl1Y', hasValue: true, hasBinding: true },
    { name: 'relativeControl2X', hasValue: true, hasBinding: true },
    { name: 'relativeControl2Y', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onControl1XChanged', paramCount: 0 },
    { handlerName: 'onControl1YChanged', paramCount: 0 },
    { handlerName: 'onControl2XChanged', paramCount: 0 },
    { handlerName: 'onControl2YChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onRelativeControl1XChanged', paramCount: 0 },
    { handlerName: 'onRelativeControl1YChanged', paramCount: 0 },
    { handlerName: 'onRelativeControl2XChanged', paramCount: 0 },
    { handlerName: 'onRelativeControl2YChanged', paramCount: 0 },
...
export function PathCubic(): PathCubicBuilder {
  return createFluentBuilder('PathCubic', PATHCUBIC_META) as unknown as PathCubicBuilder;
}
