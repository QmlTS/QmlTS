...
export interface MultiPointTouchAreaBuilder {
  ...
  focusPolicy(value: QmlEnumToken): MultiPointTouchAreaBuilder;
  ...
  transformOrigin(value: QmlEnumToken): MultiPointTouchAreaBuilder;
...
const MULTIPOINTTOUCHAREA_META: TypeMetadata = {
  typeName: 'MultiPointTouchArea',
  properties: [
    ...
    { name: 'maximumTouchPoints', hasValue: true, hasBinding: true },
    { name: 'minimumTouchPoints', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onGestureStarted', paramCount: 1 },
    { handlerName: 'onHeightChanged', paramCount: 0 },
    { handlerName: 'onImplicitHeightChanged', paramCount: 0 },
    { handlerName: 'onImplicitWidthChanged', paramCount: 0 },
    { handlerName: 'onMaximumTouchPointsChanged', paramCount: 0 },
    { handlerName: 'onMinimumTouchPointsChanged', paramCount: 0 },
    { handlerName: 'onMouseEnabledChanged', paramCount: 0 },
    ...
    { handlerName: 'onTouchUpdated', paramCount: 1 },
    { handlerName: 'onTransformOriginChanged', paramCount: 1 },
    { handlerName: 'onUpdated', paramCount: 1 },
