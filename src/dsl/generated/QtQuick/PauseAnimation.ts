...
const PAUSEANIMATION_META: TypeMetadata = {
  typeName: 'PauseAnimation',
  properties: [
...
export function PauseAnimation(): PauseAnimationBuilder {
  return createFluentBuilder('PauseAnimation', PAUSEANIMATION_META) as unknown as PauseAnimationBuilder;
}
