...
const SCALE_META: TypeMetadata = {
  typeName: 'Scale',
  properties: [
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'origin', hasValue: true, hasBinding: true },
    { name: 'xScale', hasValue: true, hasBinding: true },
    { name: 'yScale', hasValue: true, hasBinding: true },
    { name: 'zScale', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onOriginChanged', paramCount: 0 },
    { handlerName: 'onScaleChanged', paramCount: 0 },
    { handlerName: 'onXScaleChanged', paramCount: 0 },
    { handlerName: 'onYScaleChanged', paramCount: 0 },
    { handlerName: 'onZScaleChanged', paramCount: 0 },
  ],
  grouped: [
  ],
  attached: [
...
export function Scale(): ScaleBuilder {
  return createFluentBuilder('Scale', SCALE_META) as unknown as ScaleBuilder;
}
