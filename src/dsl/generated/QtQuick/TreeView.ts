...
export interface TreeViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TreeViewBuilder;
  ...
  onAcceptedButtonsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAlternatingRowsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAnimateChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAtXBeginningChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAtXEndChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAtYBeginningChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onAtYEndChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onBottomRowChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onBoundsBehaviorChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onBoundsMovementChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onCollapsed(handler: DslSignalHandlerValue): TreeViewBuilder;
  onColumnMoved(handler: DslSignalHandlerValue): TreeViewBuilder;
  onColumnSpacingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onColumnWidthProviderChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onColumnsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onContentXChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onContentYChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onCurrentColumnChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onCurrentRowChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDelegateModelAccessChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDragEnded(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDragStarted(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDraggingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDraggingHorizontallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onDraggingVerticallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onEditTriggersChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onExpanded(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickDecelerationChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickEnded(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickStarted(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickableDirectionChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickingHorizontallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFlickingVerticallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onHorizontalOvershootChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onHorizontalVelocityChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onInteractiveChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onIsAtBoundaryChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onKeyNavigationEnabledChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onLayoutChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onLeftColumnChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMaximumFlickVelocityChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onModelChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMovementEnded(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMovementStarted(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMovingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMovingHorizontallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onMovingVerticallyChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onOriginXChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onOriginYChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TreeViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onPixelAlignedChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onPointerNavigationEnabledChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onPressDelayChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onReboundChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onResizableColumnsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onResizableRowsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onReuseItemsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRightColumnChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRootIndexChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRowHeightProviderChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRowMoved(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRowSpacingChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onRowsChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSelectionBehaviorChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSelectionModeChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSelectionModelChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSyncDirectionChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSyncViewChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onSynchronousDragChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onTopRowChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onVerticalOvershootChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onVerticalVelocityChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): TreeViewBuilder;
