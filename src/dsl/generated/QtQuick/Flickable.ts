...
export interface FlickableBuilder {
  ...
  onAcceptedButtonsChanged(body: string): FlickableBuilder;
  onActiveFocusChanged(body: string): FlickableBuilder;
  onActiveFocusOnTabChanged(body: string): FlickableBuilder;
  onAntialiasingChanged(body: string): FlickableBuilder;
  onAtXBeginningChanged(body: string): FlickableBuilder;
  onAtXEndChanged(body: string): FlickableBuilder;
  onAtYBeginningChanged(body: string): FlickableBuilder;
  onAtYEndChanged(body: string): FlickableBuilder;
  onBaselineOffsetChanged(body: string): FlickableBuilder;
  onBottomMarginChanged(body: string): FlickableBuilder;
  onBoundsBehaviorChanged(body: string): FlickableBuilder;
  onBoundsMovementChanged(body: string): FlickableBuilder;
  onChildrenChanged(body: string): FlickableBuilder;
  onChildrenRectChanged(body: string): FlickableBuilder;
  onClipChanged(body: string): FlickableBuilder;
  onContainmentMaskChanged(body: string): FlickableBuilder;
  onContentHeightChanged(body: string): FlickableBuilder;
  onContentWidthChanged(body: string): FlickableBuilder;
  onContentXChanged(body: string): FlickableBuilder;
  onContentYChanged(body: string): FlickableBuilder;
  onDragEnded(body: string): FlickableBuilder;
  onDragStarted(body: string): FlickableBuilder;
  onDraggingChanged(body: string): FlickableBuilder;
  onDraggingHorizontallyChanged(body: string): FlickableBuilder;
  onDraggingVerticallyChanged(body: string): FlickableBuilder;
  onEnabledChanged(body: string): FlickableBuilder;
  onFlickDecelerationChanged(body: string): FlickableBuilder;
  onFlickEnded(body: string): FlickableBuilder;
  onFlickStarted(body: string): FlickableBuilder;
  onFlickableDirectionChanged(body: string): FlickableBuilder;
  onFlickingChanged(body: string): FlickableBuilder;
  onFlickingHorizontallyChanged(body: string): FlickableBuilder;
  onFlickingVerticallyChanged(body: string): FlickableBuilder;
  onFocusChanged(body: string): FlickableBuilder;
  onFocusPolicyChanged(body: string): FlickableBuilder;
  onHeightChanged(body: string): FlickableBuilder;
  onHorizontalOvershootChanged(body: string): FlickableBuilder;
  onHorizontalVelocityChanged(body: string): FlickableBuilder;
  onImplicitHeightChanged(body: string): FlickableBuilder;
  onImplicitWidthChanged(body: string): FlickableBuilder;
  onInteractiveChanged(body: string): FlickableBuilder;
  onIsAtBoundaryChanged(body: string): FlickableBuilder;
  onLeftMarginChanged(body: string): FlickableBuilder;
  onMaximumFlickVelocityChanged(body: string): FlickableBuilder;
  onMovementEnded(body: string): FlickableBuilder;
  onMovementStarted(body: string): FlickableBuilder;
  onMovingChanged(body: string): FlickableBuilder;
  onMovingHorizontallyChanged(body: string): FlickableBuilder;
  onMovingVerticallyChanged(body: string): FlickableBuilder;
  onObjectNameChanged(body: string): FlickableBuilder;
  onOpacityChanged(body: string): FlickableBuilder;
  onOriginXChanged(body: string): FlickableBuilder;
  onOriginYChanged(body: string): FlickableBuilder;
  onPaletteChanged(body: string): FlickableBuilder;
  onPaletteCreated(body: string): FlickableBuilder;
  onParentChanged(body: string): FlickableBuilder;
  onPixelAlignedChanged(body: string): FlickableBuilder;
  onPressDelayChanged(body: string): FlickableBuilder;
  onReboundChanged(body: string): FlickableBuilder;
  onRightMarginChanged(body: string): FlickableBuilder;
  onRotationChanged(body: string): FlickableBuilder;
  onScaleChanged(body: string): FlickableBuilder;
  onSmoothChanged(body: string): FlickableBuilder;
  onStateChanged(body: string): FlickableBuilder;
  onSynchronousDragChanged(body: string): FlickableBuilder;
  onTopMarginChanged(body: string): FlickableBuilder;
  onTransformOriginChanged(body: string): FlickableBuilder;
  onVerticalOvershootChanged(body: string): FlickableBuilder;
  onVerticalVelocityChanged(body: string): FlickableBuilder;
  onVisibleChanged(body: string): FlickableBuilder;
  onVisibleChildrenChanged(body: string): FlickableBuilder;
  onWidthChanged(body: string): FlickableBuilder;
  onWindowChanged(body: string): FlickableBuilder;
  onXChanged(body: string): FlickableBuilder;
  onYChanged(body: string): FlickableBuilder;
  onZChanged(body: string): FlickableBuilder;
