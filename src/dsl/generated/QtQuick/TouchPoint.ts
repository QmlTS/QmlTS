...
const TOUCHPOINT_META: TypeMetadata = {
  typeName: 'TouchPoint',
  properties: [
    { name: 'objectName', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onAreaChanged', paramCount: 0 },
    { handlerName: 'onEllipseDiametersChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onPointIdChanged', paramCount: 0 },
    { handlerName: 'onPressedChanged', paramCount: 0 },
    { handlerName: 'onPressureChanged', paramCount: 0 },
    { handlerName: 'onPreviousXChanged', paramCount: 0 },
    { handlerName: 'onPreviousYChanged', paramCount: 0 },
    { handlerName: 'onRotationChanged', paramCount: 0 },
    { handlerName: 'onSceneXChanged', paramCount: 0 },
    { handlerName: 'onSceneYChanged', paramCount: 0 },
    { handlerName: 'onStartXChanged', paramCount: 0 },
    { handlerName: 'onStartYChanged', paramCount: 0 },
    { handlerName: 'onUniqueIdChanged', paramCount: 0 },
...
export function TouchPoint(): TouchPointBuilder {
  return createFluentBuilder('TouchPoint', TOUCHPOINT_META) as unknown as TouchPointBuilder;
}
