...
const FRAMEANIMATION_META: TypeMetadata = {
  typeName: 'FrameAnimation',
  properties: [
  ...
  signals: [
    ...
    { handlerName: 'onElapsedTimeChanged', paramCount: 0 },
    { handlerName: 'onFrameTimeChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onPausedChanged', paramCount: 0 },
    { handlerName: 'onRunningChanged', paramCount: 0 },
    { handlerName: 'onSmoothFrameTimeChanged', paramCount: 0 },
...
export function FrameAnimation(): FrameAnimationBuilder {
  return createFluentBuilder('FrameAnimation', FRAMEANIMATION_META) as unknown as FrameAnimationBuilder;
}
