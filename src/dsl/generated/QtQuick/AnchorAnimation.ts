...
const ANCHORANIMATION_META: TypeMetadata = {
  typeName: 'AnchorAnimation',
  properties: [
...
export function AnchorAnimation(): AnchorAnimationBuilder {
  return createFluentBuilder('AnchorAnimation', ANCHORANIMATION_META) as unknown as AnchorAnimationBuilder;
}
