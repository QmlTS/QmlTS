...
export interface SmoothedAnimationBuilder {
  ...
  reversingMode(value: QmlEnumToken): SmoothedAnimationBuilder;
...
const SMOOTHEDANIMATION_META: TypeMetadata = {
  typeName: 'SmoothedAnimation',
  properties: [
    ...
    { name: 'maximumEasingTime', hasValue: true, hasBinding: true },
    ...
    { name: 'reversingMode', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onMaximumEasingTimeChanged', paramCount: 0 },
    ...
    { handlerName: 'onReversingModeChanged', paramCount: 0 },
