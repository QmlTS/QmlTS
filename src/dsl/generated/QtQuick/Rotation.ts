...
const ROTATION_META: TypeMetadata = {
  typeName: 'Rotation',
  properties: [
    { name: 'angle', hasValue: true, hasBinding: true },
    { name: 'axis', hasValue: true, hasBinding: true },
    { name: 'distanceToPlane', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'origin', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onAngleChanged', paramCount: 0 },
    { handlerName: 'onAxisChanged', paramCount: 0 },
    { handlerName: 'onDistanceToPlaneChanged', paramCount: 0 },
...
export function Rotation(): RotationBuilder {
  return createFluentBuilder('Rotation', ROTATION_META) as unknown as RotationBuilder;
}
