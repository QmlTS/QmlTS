...
const VIEWSECTION_META: TypeMetadata = {
  typeName: 'ViewSection',
  properties: [
    { name: 'criteria', hasValue: true, hasBinding: true },
    { name: 'delegate', hasValue: true, hasBinding: true },
    { name: 'labelPositioning', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'property', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onCriteriaChanged', paramCount: 0 },
    { handlerName: 'onDelegateChanged', paramCount: 0 },
    { handlerName: 'onLabelPositioningChanged', paramCount: 0 },
...
export function ViewSection(): ViewSectionBuilder {
  return createFluentBuilder('ViewSection', VIEWSECTION_META) as unknown as ViewSectionBuilder;
}
