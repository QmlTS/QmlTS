...
export interface ImageBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ImageBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onAsynchronousChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onAutoTransformChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onCacheChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onColorSpaceChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onCurrentFrameChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onFillModeChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onFrameCountChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onMipmapChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onMirrorChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onMirrorVerticallyChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onPaintedGeometryChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ImageBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onProgressChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onRetainWhileLoadingChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onSourceClipRectChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onSourceSizeChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onStatusChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onXChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onYChanged(handler: DslSignalHandlerValue): ImageBuilder;
  onZChanged(handler: DslSignalHandlerValue): ImageBuilder;
