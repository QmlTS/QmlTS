...
const PATHQUAD_META: TypeMetadata = {
  typeName: 'PathQuad',
  properties: [
    { name: 'controlX', hasValue: true, hasBinding: true },
    { name: 'controlY', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'relativeControlX', hasValue: true, hasBinding: true },
    { name: 'relativeControlY', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onControlXChanged', paramCount: 0 },
    { handlerName: 'onControlYChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onRelativeControlXChanged', paramCount: 0 },
    { handlerName: 'onRelativeControlYChanged', paramCount: 0 },
...
export function PathQuad(): PathQuadBuilder {
  return createFluentBuilder('PathQuad', PATHQUAD_META) as unknown as PathQuadBuilder;
}
