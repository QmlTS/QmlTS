...
const PARENTANIMATION_META: TypeMetadata = {
  typeName: 'ParentAnimation',
  properties: [
    { name: 'alwaysRunToEnd', hasValue: true, hasBinding: true },
    { name: 'loops', hasValue: true, hasBinding: true },
    { name: 'newParent', hasValue: true, hasBinding: true },
    ...
    { name: 'via', hasValue: true, hasBinding: true },
  ],
  signals: [
    ...
    { handlerName: 'onNewParentChanged', paramCount: 0 },
    ...
    { handlerName: 'onViaChanged', paramCount: 0 },
  ],
  grouped: [
  ],
  attached: [
...
export function ParentAnimation(): ParentAnimationBuilder {
  return createFluentBuilder('ParentAnimation', PARENTANIMATION_META) as unknown as ParentAnimationBuilder;
}
