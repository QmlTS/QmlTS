...
const PROPERTYANIMATION_META: TypeMetadata = {
  typeName: 'PropertyAnimation',
  properties: [
...
export function PropertyAnimation(): PropertyAnimationBuilder {
  return createFluentBuilder('PropertyAnimation', PROPERTYANIMATION_META) as unknown as PropertyAnimationBuilder;
}
