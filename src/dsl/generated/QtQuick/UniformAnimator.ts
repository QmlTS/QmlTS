...
const UNIFORMANIMATOR_META: TypeMetadata = {
  typeName: 'UniformAnimator',
  properties: [
    ...
    { name: 'uniform', hasValue: true, hasBinding: true },
  ],
  signals: [
    ...
    { handlerName: 'onUniformChanged', paramCount: 1 },
  ],
  grouped: [
  ],
  attached: [
...
export function UniformAnimator(): UniformAnimatorBuilder {
  return createFluentBuilder('UniformAnimator', UNIFORMANIMATOR_META) as unknown as UniformAnimatorBuilder;
}
