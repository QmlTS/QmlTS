...
const PATHMULTILINE_META: TypeMetadata = {
  typeName: 'PathMultiline',
  properties: [
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'paths', hasValue: true, hasBinding: true },
...
export function PathMultiline(): PathMultilineBuilder {
  return createFluentBuilder('PathMultiline', PATHMULTILINE_META) as unknown as PathMultilineBuilder;
}
