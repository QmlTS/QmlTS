...
export interface FocusScopeBuilder {
  ...
  focusPolicy(value: QmlEnumToken): FocusScopeBuilder;
  ...
  transformOrigin(value: QmlEnumToken): FocusScopeBuilder;
...
const FOCUSSCOPE_META: TypeMetadata = {
  typeName: 'FocusScope',
  properties: [
...
export function FocusScope(): FocusScopeBuilder {
  return createFluentBuilder('FocusScope', FOCUSSCOPE_META) as unknown as FocusScopeBuilder;
}
