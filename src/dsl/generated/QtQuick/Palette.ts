...
const PALETTE_META: TypeMetadata = {
  typeName: 'Palette',
  properties: [
    { name: 'accent', hasValue: true, hasBinding: true },
    { name: 'active', hasValue: true, hasBinding: true },
    { name: 'alternateBase', hasValue: true, hasBinding: true },
    { name: 'base', hasValue: true, hasBinding: true },
    { name: 'brightText', hasValue: true, hasBinding: true },
    { name: 'button', hasValue: true, hasBinding: true },
    { name: 'buttonText', hasValue: true, hasBinding: true },
    { name: 'dark', hasValue: true, hasBinding: true },
    { name: 'disabled', hasValue: true, hasBinding: true },
    { name: 'highlight', hasValue: true, hasBinding: true },
    { name: 'highlightedText', hasValue: true, hasBinding: true },
    { name: 'inactive', hasValue: true, hasBinding: true },
    { name: 'light', hasValue: true, hasBinding: true },
    { name: 'link', hasValue: true, hasBinding: true },
    { name: 'linkVisited', hasValue: true, hasBinding: true },
    { name: 'mid', hasValue: true, hasBinding: true },
    { name: 'midlight', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'placeholderText', hasValue: true, hasBinding: true },
    { name: 'shadow', hasValue: true, hasBinding: true },
    { name: 'text', hasValue: true, hasBinding: true },
    { name: 'toolTipBase', hasValue: true, hasBinding: true },
    { name: 'toolTipText', hasValue: true, hasBinding: true },
    { name: 'window', hasValue: true, hasBinding: true },
    { name: 'windowText', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onAccentChanged', paramCount: 0 },
    { handlerName: 'onActiveChanged', paramCount: 0 },
    { handlerName: 'onAlternateBaseChanged', paramCount: 0 },
    { handlerName: 'onBaseChanged', paramCount: 0 },
    { handlerName: 'onBrightTextChanged', paramCount: 0 },
    { handlerName: 'onButtonChanged', paramCount: 0 },
    { handlerName: 'onButtonTextChanged', paramCount: 0 },
    ...
    { handlerName: 'onHighlightedTextChanged', paramCount: 0 },
    { handlerName: 'onInactiveChanged', paramCount: 0 },
    { handlerName: 'onLightChanged', paramCount: 0 },
    { handlerName: 'onLinkChanged', paramCount: 0 },
    { handlerName: 'onLinkVisitedChanged', paramCount: 0 },
    { handlerName: 'onMidChanged', paramCount: 0 },
    { handlerName: 'onMidlightChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onPlaceholderTextChanged', paramCount: 0 },
    { handlerName: 'onShadowChanged', paramCount: 0 },
    { handlerName: 'onTextChanged', paramCount: 0 },
    { handlerName: 'onToolTipBaseChanged', paramCount: 0 },
    { handlerName: 'onToolTipTextChanged', paramCount: 0 },
    { handlerName: 'onWindowChanged', paramCount: 0 },
    { handlerName: 'onWindowTextChanged', paramCount: 0 },
  ],
  grouped: [
  ],
  attached: [
...
export function Palette(): PaletteBuilder {
  return createFluentBuilder('Palette', PALETTE_META) as unknown as PaletteBuilder;
}
