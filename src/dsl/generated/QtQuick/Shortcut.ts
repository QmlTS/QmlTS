...
export interface ShortcutBuilder {
  ...
  context(value: QmlEnumToken): ShortcutBuilder;
...
const SHORTCUT_META: TypeMetadata = {
  typeName: 'Shortcut',
  properties: [
    { name: 'autoRepeat', hasValue: true, hasBinding: true },
    { name: 'context', hasValue: true, hasBinding: true },
    { name: 'enabled', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'sequence', hasValue: true, hasBinding: true },
    { name: 'sequences', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onActivated', paramCount: 0 },
    { handlerName: 'onActivatedAmbiguously', paramCount: 0 },
    { handlerName: 'onAutoRepeatChanged', paramCount: 0 },
    { handlerName: 'onContextChanged', paramCount: 0 },
    { handlerName: 'onEnabledChanged', paramCount: 0 },
    { handlerName: 'onNativeTextChanged', paramCount: 0 },
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onPortableTextChanged', paramCount: 0 },
    { handlerName: 'onSequenceChanged', paramCount: 0 },
    { handlerName: 'onSequencesChanged', paramCount: 0 },
  ],
  grouped: [],
  attached: [
    {
...
export function Shortcut(): ShortcutBuilder {
  return createFluentBuilder('Shortcut', SHORTCUT_META) as unknown as ShortcutBuilder;
}
