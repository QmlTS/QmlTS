...
const PATHINTERPOLATOR_META: TypeMetadata = {
  typeName: 'PathInterpolator',
  properties: [
...
export function PathInterpolator(): PathInterpolatorBuilder {
  return createFluentBuilder('PathInterpolator', PATHINTERPOLATOR_META) as unknown as PathInterpolatorBuilder;
}
