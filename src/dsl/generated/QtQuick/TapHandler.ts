...
export interface TapHandlerBuilder {
  ...
  acceptedDevices(value: QmlEnumToken): TapHandlerBuilder;
  acceptedDevicesBind(expr: string): TapHandlerBuilder;
  acceptedModifiers(value: QmlEnumToken): TapHandlerBuilder;
  acceptedModifiersBind(expr: string): TapHandlerBuilder;
  acceptedPointerTypes(value: QmlEnumToken): TapHandlerBuilder;
  acceptedPointerTypesBind(expr: string): TapHandlerBuilder;
  cursorShape(value: QmlEnumToken): TapHandlerBuilder;
  ...
  exclusiveSignals(value: QmlEnumToken): TapHandlerBuilder;
  exclusiveSignalsBind(expr: string): TapHandlerBuilder;
  gesturePolicy(value: QmlEnumToken): TapHandlerBuilder;
  gesturePolicyBind(expr: string): TapHandlerBuilder;
  grabPermissions(value: QmlEnumToken): TapHandlerBuilder;
...
const TAPHANDLER_META: TypeMetadata = {
  typeName: 'TapHandler',
  properties: [
    ...
    { name: 'exclusiveSignals', hasValue: true, hasBinding: true },
    { name: 'gesturePolicy', hasValue: true, hasBinding: true },
    { name: 'grabPermissions', hasValue: true, hasBinding: true },
    { name: 'longPressThreshold', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onExclusiveSignalsChanged', paramCount: 0 },
    { handlerName: 'onGesturePolicyChanged', paramCount: 0 },
    { handlerName: 'onGrabChanged', paramCount: 2 },
    { handlerName: 'onGrabPermissionChanged', paramCount: 0 },
    { handlerName: 'onLongPressThresholdChanged', paramCount: 0 },
    ...
    { handlerName: 'onSingleTapped', paramCount: 2 },
    { handlerName: 'onTapCountChanged', paramCount: 0 },
...
export function TapHandler(): TapHandlerBuilder {
  return createFluentBuilder('TapHandler', TAPHANDLER_META) as unknown as TapHandlerBuilder;
}
