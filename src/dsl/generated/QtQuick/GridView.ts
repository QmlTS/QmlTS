...
export interface GridViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): GridViewBuilder;
  ...
  onAcceptedButtonsChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAddDisplacedTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAddTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAtXBeginningChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAtXEndChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAtYBeginningChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onAtYEndChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onBoundsBehaviorChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onBoundsMovementChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCacheBufferChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCellHeightChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCellWidthChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onContentXChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onContentYChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCountChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDelegateModelAccessChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDisplacedTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDisplayMarginBeginningChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDisplayMarginEndChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDragEnded(handler: DslSignalHandlerValue): GridViewBuilder;
  onDragStarted(handler: DslSignalHandlerValue): GridViewBuilder;
  onDraggingChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDraggingHorizontallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onDraggingVerticallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onEffectiveLayoutDirectionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickDecelerationChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickEnded(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickStarted(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickableDirectionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickingChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickingHorizontallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlickingVerticallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFlowChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFooterChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onFooterItemChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHeaderChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHeaderItemChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHighlightChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHighlightFollowsCurrentItemChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHighlightItemChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHighlightMoveDurationChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHighlightRangeModeChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHorizontalOvershootChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onHorizontalVelocityChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onInteractiveChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onIsAtBoundaryChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onKeyNavigationEnabledChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onKeyNavigationWrapsChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onLayoutDirectionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMaximumFlickVelocityChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onModelChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMoveDisplacedTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMoveTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMovementEnded(handler: DslSignalHandlerValue): GridViewBuilder;
  onMovementStarted(handler: DslSignalHandlerValue): GridViewBuilder;
  onMovingChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMovingHorizontallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onMovingVerticallyChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onOriginXChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onOriginYChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): GridViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPixelAlignedChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPopulateTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPreferredHighlightBeginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPreferredHighlightEndChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onPressDelayChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onReboundChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onRemoveDisplacedTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onRemoveTransitionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onReuseItemsChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onSnapModeChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onSynchronousDragChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onVerticalLayoutDirectionChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onVerticalOvershootChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onVerticalVelocityChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): GridViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): GridViewBuilder;
