...
export interface PathViewBuilder {
  ...
  onActiveFocusChanged(body: string): PathViewBuilder;
  onActiveFocusOnTabChanged(body: string): PathViewBuilder;
  onAntialiasingChanged(body: string): PathViewBuilder;
  onBaselineOffsetChanged(body: string): PathViewBuilder;
  onCacheItemCountChanged(body: string): PathViewBuilder;
  onChildrenChanged(body: string): PathViewBuilder;
  onChildrenRectChanged(body: string): PathViewBuilder;
  onClipChanged(body: string): PathViewBuilder;
  onContainmentMaskChanged(body: string): PathViewBuilder;
  onCountChanged(body: string): PathViewBuilder;
  onCurrentIndexChanged(body: string): PathViewBuilder;
  onCurrentItemChanged(body: string): PathViewBuilder;
  onDelegateChanged(body: string): PathViewBuilder;
  onDragEnded(body: string): PathViewBuilder;
  onDragMarginChanged(body: string): PathViewBuilder;
  onDragStarted(body: string): PathViewBuilder;
  onDraggingChanged(body: string): PathViewBuilder;
  onEnabledChanged(body: string): PathViewBuilder;
  onFlickDecelerationChanged(body: string): PathViewBuilder;
  onFlickEnded(body: string): PathViewBuilder;
  onFlickStarted(body: string): PathViewBuilder;
  onFlickingChanged(body: string): PathViewBuilder;
  onFocusChanged(body: string): PathViewBuilder;
  onFocusPolicyChanged(body: string): PathViewBuilder;
  onHeightChanged(body: string): PathViewBuilder;
  onHighlightChanged(body: string): PathViewBuilder;
  onHighlightItemChanged(body: string): PathViewBuilder;
  onHighlightMoveDurationChanged(body: string): PathViewBuilder;
  onHighlightRangeModeChanged(body: string): PathViewBuilder;
  onImplicitHeightChanged(body: string): PathViewBuilder;
  onImplicitWidthChanged(body: string): PathViewBuilder;
  onInteractiveChanged(body: string): PathViewBuilder;
  onMaximumFlickVelocityChanged(body: string): PathViewBuilder;
  onModelChanged(body: string): PathViewBuilder;
  onMovementDirectionChanged(body: string): PathViewBuilder;
  onMovementEnded(body: string): PathViewBuilder;
  onMovementStarted(body: string): PathViewBuilder;
  onMovingChanged(body: string): PathViewBuilder;
  onObjectNameChanged(body: string): PathViewBuilder;
  onOffsetChanged(body: string): PathViewBuilder;
  onOpacityChanged(body: string): PathViewBuilder;
  onPaletteChanged(body: string): PathViewBuilder;
  onPaletteCreated(body: string): PathViewBuilder;
  onParentChanged(body: string): PathViewBuilder;
  onPathChanged(body: string): PathViewBuilder;
  onPathItemCountChanged(body: string): PathViewBuilder;
  onPreferredHighlightBeginChanged(body: string): PathViewBuilder;
  onPreferredHighlightEndChanged(body: string): PathViewBuilder;
  onRotationChanged(body: string): PathViewBuilder;
  onScaleChanged(body: string): PathViewBuilder;
  onSmoothChanged(body: string): PathViewBuilder;
  onSnapModeChanged(body: string): PathViewBuilder;
  onSnapPositionChanged(body: string): PathViewBuilder;
  onStateChanged(body: string): PathViewBuilder;
  onTransformOriginChanged(body: string): PathViewBuilder;
  onVisibleChanged(body: string): PathViewBuilder;
  onVisibleChildrenChanged(body: string): PathViewBuilder;
  onWidthChanged(body: string): PathViewBuilder;
  onWindowChanged(body: string): PathViewBuilder;
  onXChanged(body: string): PathViewBuilder;
  onYChanged(body: string): PathViewBuilder;
  onZChanged(body: string): PathViewBuilder;
...
export namespace PathView {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('PathView', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('PathView', 'Flags', 'ItemAcceptsInputMethod');
    ...
    export const ItemObservesViewport = createEnumToken('PathView', 'Flags', 'ItemObservesViewport');
  }
  export namespace HighlightRangeMode {
    export const NoHighlightRange = createEnumToken('PathView', 'HighlightRangeMode', 'NoHighlightRange');
    export const ApplyRange = createEnumToken('PathView', 'HighlightRangeMode', 'ApplyRange');
    export const StrictlyEnforceRange = createEnumToken('PathView', 'HighlightRangeMode', 'StrictlyEnforceRange');
  }
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('PathView', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('PathView', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('PathView', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('PathView', 'ItemChange', 'ItemTransformHasChanged');
  }
