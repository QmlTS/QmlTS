...
const PATHRECTANGLE_META: TypeMetadata = {
  typeName: 'PathRectangle',
  properties: [
    ...
    { name: 'strokeAdjustment', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onStrokeAdjustmentChanged', paramCount: 0 },
...
export function PathRectangle(): PathRectangleBuilder {
  return createFluentBuilder('PathRectangle', PATHRECTANGLE_META) as unknown as PathRectangleBuilder;
}
