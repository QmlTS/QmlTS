...
export interface ItemBuilder {
  ...
  focusPolicy(value: QmlEnumToken): ItemBuilder;
  ...
  transformOrigin(value: QmlEnumToken): ItemBuilder;
  ...
  onActiveFocusChanged(body: string): ItemBuilder;
  onActiveFocusOnTabChanged(body: string): ItemBuilder;
  onAntialiasingChanged(body: string): ItemBuilder;
  onBaselineOffsetChanged(body: string): ItemBuilder;
  onChildrenChanged(body: string): ItemBuilder;
  onChildrenRectChanged(body: string): ItemBuilder;
  onClipChanged(body: string): ItemBuilder;
  onContainmentMaskChanged(body: string): ItemBuilder;
  onEnabledChanged(body: string): ItemBuilder;
  onFocusChanged(body: string): ItemBuilder;
  onFocusPolicyChanged(body: string): ItemBuilder;
  onHeightChanged(body: string): ItemBuilder;
  onImplicitHeightChanged(body: string): ItemBuilder;
  onImplicitWidthChanged(body: string): ItemBuilder;
  onObjectNameChanged(body: string): ItemBuilder;
  onOpacityChanged(body: string): ItemBuilder;
  onPaletteChanged(body: string): ItemBuilder;
  onPaletteCreated(body: string): ItemBuilder;
  onParentChanged(body: string): ItemBuilder;
  onRotationChanged(body: string): ItemBuilder;
  onScaleChanged(body: string): ItemBuilder;
  onSmoothChanged(body: string): ItemBuilder;
  onStateChanged(body: string): ItemBuilder;
  onTransformOriginChanged(body: string): ItemBuilder;
  onVisibleChanged(body: string): ItemBuilder;
  onVisibleChildrenChanged(body: string): ItemBuilder;
  onWidthChanged(body: string): ItemBuilder;
  onWindowChanged(body: string): ItemBuilder;
  onXChanged(body: string): ItemBuilder;
  onYChanged(body: string): ItemBuilder;
  onZChanged(body: string): ItemBuilder;
...
export function Item(): ItemBuilder {
  return createFluentBuilder('Item', ITEM_META) as unknown as ItemBuilder;
}

export namespace Item {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('Item', 'Flags', 'ItemClipsChildrenToShape');
    export const ItemAcceptsInputMethod = createEnumToken('Item', 'Flags', 'ItemAcceptsInputMethod');
  ...
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('Item', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('Item', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('Item', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('Item', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('Item', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('Item', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('Item', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('Item', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('Item', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('Item', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('Item', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('Item', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('Item', 'ItemChange', 'ItemTransformHasChanged');
  }
