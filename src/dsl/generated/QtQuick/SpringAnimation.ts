...
const SPRINGANIMATION_META: TypeMetadata = {
  ...
  properties: [
    ...
    { name: 'spring', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onMassChanged', paramCount: 0 },
    { handlerName: 'onModulusChanged', paramCount: 0 },
    ...
    { handlerName: 'onSyncChanged', paramCount: 0 },
...
export function SpringAnimation(): SpringAnimationBuilder {
  return createFluentBuilder('SpringAnimation', SPRINGANIMATION_META) as unknown as SpringAnimationBuilder;
}
