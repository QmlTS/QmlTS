...
export interface TextInputBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TextInputBuilder;
  ...
  onAcceptableInputChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onAccepted(handler: DslSignalHandlerValue): TextInputBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onActiveFocusOnPressChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onAutoScrollChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCanPasteChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCanRedoChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCanUndoChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onColorChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onContentSizeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCursorDelegateChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCursorPositionChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCursorRectangleChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onCursorVisibleChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onDisplayTextChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onEchoModeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onEditingFinished(handler: DslSignalHandlerValue): TextInputBuilder;
  onEffectiveHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onFontChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onInputMaskChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onInputMethodComposingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onInputMethodHintsChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onMaximumLengthChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onMouseSelectionModeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onOverwriteModeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TextInputBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPasswordCharacterChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPasswordMaskDelayChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPersistentSelectionChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onPreeditTextChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onReadOnlyChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onRenderTypeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectByMouseChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectedTextChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectedTextColorChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectionColorChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectionEndChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSelectionStartChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onTextChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onTextEdited(handler: DslSignalHandlerValue): TextInputBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onValidatorChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onWrapModeChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onXChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onYChanged(handler: DslSignalHandlerValue): TextInputBuilder;
  onZChanged(handler: DslSignalHandlerValue): TextInputBuilder;
