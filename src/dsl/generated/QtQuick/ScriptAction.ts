...
const SCRIPTACTION_META: TypeMetadata = {
  ...
  properties: [
    ...
    { name: 'scriptName', hasValue: true, hasBinding: true },
  ],
  signals: [
...
export function ScriptAction(): ScriptActionBuilder {
  return createFluentBuilder('ScriptAction', SCRIPTACTION_META) as unknown as ScriptActionBuilder;
}
