...
export interface PointHandlerBuilder {
  ...
  acceptedDevices(value: QmlEnumToken): PointHandlerBuilder;
  acceptedDevicesBind(expr: string): PointHandlerBuilder;
  acceptedModifiers(value: QmlEnumToken): PointHandlerBuilder;
  acceptedModifiersBind(expr: string): PointHandlerBuilder;
  acceptedPointerTypes(value: QmlEnumToken): PointHandlerBuilder;
  acceptedPointerTypesBind(expr: string): PointHandlerBuilder;
  cursorShape(value: QmlEnumToken): PointHandlerBuilder;
  ...
  grabPermissions(value: QmlEnumToken): PointHandlerBuilder;
...
const POINTHANDLER_META: TypeMetadata = {
  typeName: 'PointHandler',
  properties: [
...
export function PointHandler(): PointHandlerBuilder {
  return createFluentBuilder('PointHandler', POINTHANDLER_META) as unknown as PointHandlerBuilder;
}
