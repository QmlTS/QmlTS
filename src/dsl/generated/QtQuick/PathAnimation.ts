...
export interface PathAnimationBuilder {
  ...
  orientation(value: QmlEnumToken): PathAnimationBuilder;
...
const PATHANIMATION_META: TypeMetadata = {
  typeName: 'PathAnimation',
  properties: [
    ...
    { name: 'endRotation', hasValue: true, hasBinding: true },
    { name: 'loops', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'orientation', hasValue: true, hasBinding: true },
    { name: 'orientationEntryDuration', hasValue: true, hasBinding: true },
    { name: 'orientationExitDuration', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onAnchorPointChanged', paramCount: 1 },
    { handlerName: 'onDurationChanged', paramCount: 1 },
    { handlerName: 'onEasingChanged', paramCount: 1 },
    { handlerName: 'onEndRotationChanged', paramCount: 1 },
    ...
    { handlerName: 'onOrientationEntryDurationChanged', paramCount: 1 },
    { handlerName: 'onOrientationExitDurationChanged', paramCount: 1 },
...
export function PathAnimation(): PathAnimationBuilder {
  return createFluentBuilder('PathAnimation', PATHANIMATION_META) as unknown as PathAnimationBuilder;
}
