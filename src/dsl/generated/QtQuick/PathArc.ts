...
const PATHARC_META: TypeMetadata = {
  typeName: 'PathArc',
  properties: [
    { name: 'direction', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'radiusX', hasValue: true, hasBinding: true },
    { name: 'radiusY', hasValue: true, hasBinding: true },
    { name: 'relativeX', hasValue: true, hasBinding: true },
    { name: 'relativeY', hasValue: true, hasBinding: true },
    { name: 'useLargeArc', hasValue: true, hasBinding: true },
    { name: 'x', hasValue: true, hasBinding: true },
    { name: 'xAxisRotation', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onRadiusXChanged', paramCount: 0 },
    { handlerName: 'onRadiusYChanged', paramCount: 0 },
    { handlerName: 'onRelativeXChanged', paramCount: 0 },
    { handlerName: 'onRelativeYChanged', paramCount: 0 },
    { handlerName: 'onUseLargeArcChanged', paramCount: 0 },
    { handlerName: 'onXAxisRotationChanged', paramCount: 0 },
...
export function PathArc(): PathArcBuilder {
  return createFluentBuilder('PathArc', PATHARC_META) as unknown as PathArcBuilder;
}
