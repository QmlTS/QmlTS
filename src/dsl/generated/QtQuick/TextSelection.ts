...
const TEXTSELECTION_META: TypeMetadata = {
  typeName: 'TextSelection',
  properties: [
    ...
    { name: 'selectionEnd', hasValue: true, hasBinding: true },
    { name: 'selectionStart', hasValue: true, hasBinding: true },
