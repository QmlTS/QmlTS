...
export interface TextBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TextBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): TextBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TextBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onBaseUrlChanged(handler: DslSignalHandlerValue): TextBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TextBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TextBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TextBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TextBuilder;
  onColorChanged(handler: DslSignalHandlerValue): TextBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TextBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): TextBuilder;
  onContentSizeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): TextBuilder;
  onEffectiveHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextBuilder;
  onElideModeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TextBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TextBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TextBuilder;
  onFontChanged(handler: DslSignalHandlerValue): TextBuilder;
  onFontInfoChanged(handler: DslSignalHandlerValue): TextBuilder;
  onFontSizeModeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TextBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): TextBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TextBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLineCountChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLineHeightChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLineHeightModeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLineLaidOut(handler: DslSignalHandlerValue): TextBuilder;
  onLinkActivated(handler: DslSignalHandlerValue): TextBuilder;
  onLinkColorChanged(handler: DslSignalHandlerValue): TextBuilder;
  onLinkHovered(handler: DslSignalHandlerValue): TextBuilder;
  onMaximumLineCountChanged(handler: DslSignalHandlerValue): TextBuilder;
  onMinimumPixelSizeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onMinimumPointSizeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TextBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TextBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TextBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TextBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TextBuilder;
  onRenderTypeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onRenderTypeQualityChanged(handler: DslSignalHandlerValue): TextBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TextBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TextBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TextBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TextBuilder;
  onStyleChanged(handler: DslSignalHandlerValue): TextBuilder;
  onStyleColorChanged(handler: DslSignalHandlerValue): TextBuilder;
  onTextChanged(handler: DslSignalHandlerValue): TextBuilder;
  onTextFormatChanged(handler: DslSignalHandlerValue): TextBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): TextBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TextBuilder;
  onTruncatedChanged(handler: DslSignalHandlerValue): TextBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): TextBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TextBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TextBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TextBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TextBuilder;
  onWrapModeChanged(handler: DslSignalHandlerValue): TextBuilder;
  onXChanged(handler: DslSignalHandlerValue): TextBuilder;
  onYChanged(handler: DslSignalHandlerValue): TextBuilder;
  onZChanged(handler: DslSignalHandlerValue): TextBuilder;
