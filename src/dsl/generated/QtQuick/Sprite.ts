...
const SPRITE_META: TypeMetadata = {
  typeName: 'Sprite',
  properties: [
    ...
    { name: 'frameDurationVariation', hasValue: true, hasBinding: true },
    { name: 'frameHeight', hasValue: true, hasBinding: true },
    { name: 'frameRate', hasValue: true, hasBinding: true },
    { name: 'frameRateVariation', hasValue: true, hasBinding: true },
    ...
    { name: 'frames', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onFrameDurationVariationChanged', paramCount: 1 },
    { handlerName: 'onFrameHeightChanged', paramCount: 1 },
    { handlerName: 'onFrameRateChanged', paramCount: 1 },
    { handlerName: 'onFrameRateVariationChanged', paramCount: 1 },
...
export function Sprite(): SpriteBuilder {
  return createFluentBuilder('Sprite', SPRITE_META) as unknown as SpriteBuilder;
}
