...
export interface TableViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TableViewBuilder;
  ...
  onAcceptedButtonsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAlternatingRowsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAnimateChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAtXBeginningChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAtXEndChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAtYBeginningChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onAtYEndChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onBottomRowChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onBoundsBehaviorChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onBoundsMovementChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onColumnMoved(handler: DslSignalHandlerValue): TableViewBuilder;
  onColumnSpacingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onColumnWidthProviderChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onColumnsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onContentXChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onContentYChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onCurrentColumnChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onCurrentRowChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onDelegateModelAccessChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onDragEnded(handler: DslSignalHandlerValue): TableViewBuilder;
  onDragStarted(handler: DslSignalHandlerValue): TableViewBuilder;
  onDraggingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onDraggingHorizontallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onDraggingVerticallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onEditTriggersChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickDecelerationChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickEnded(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickStarted(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickableDirectionChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickingHorizontallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFlickingVerticallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onHorizontalOvershootChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onHorizontalVelocityChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onInteractiveChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onIsAtBoundaryChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onKeyNavigationEnabledChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onLayoutChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onLeftColumnChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onMaximumFlickVelocityChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onModelChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onMovementEnded(handler: DslSignalHandlerValue): TableViewBuilder;
  onMovementStarted(handler: DslSignalHandlerValue): TableViewBuilder;
  onMovingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onMovingHorizontallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onMovingVerticallyChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onOriginXChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onOriginYChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): TableViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onPixelAlignedChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onPointerNavigationEnabledChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onPressDelayChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onReboundChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onResizableColumnsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onResizableRowsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onReuseItemsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRightColumnChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRowHeightProviderChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRowMoved(handler: DslSignalHandlerValue): TableViewBuilder;
  onRowSpacingChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onRowsChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSelectionBehaviorChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSelectionModeChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSelectionModelChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSyncDirectionChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSyncViewChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onSynchronousDragChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onTopRowChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onVerticalOvershootChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onVerticalVelocityChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): TableViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): TableViewBuilder;
