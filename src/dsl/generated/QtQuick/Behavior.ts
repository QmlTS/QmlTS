...
const BEHAVIOR_META: TypeMetadata = {
  typeName: 'Behavior',
  properties: [
  ...
  signals: [
    ...
    { handlerName: 'onTargetValueChanged', paramCount: 0 },
  ],
  grouped: [],
  attached: [
    {
...
export function Behavior(): BehaviorBuilder {
  return createFluentBuilder('Behavior', BEHAVIOR_META) as unknown as BehaviorBuilder;
}
