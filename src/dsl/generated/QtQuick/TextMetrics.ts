...
export interface TextMetricsBuilder {
  ...
  renderType(value: QmlEnumToken): TextMetricsBuilder;
...
const TEXTMETRICS_META: TypeMetadata = {
  typeName: 'TextMetrics',
  properties: [
    { name: 'elide', hasValue: true, hasBinding: true },
    { name: 'elideWidth', hasValue: true, hasBinding: true },
  ...
  signals: [
    { handlerName: 'onElideChanged', paramCount: 0 },
    { handlerName: 'onElideWidthChanged', paramCount: 0 },
    { handlerName: 'onFontChanged', paramCount: 0 },
    { handlerName: 'onMetricsChanged', paramCount: 0 },
...
export function TextMetrics(): TextMetricsBuilder {
  return createFluentBuilder('TextMetrics', TEXTMETRICS_META) as unknown as TextMetricsBuilder;
}
