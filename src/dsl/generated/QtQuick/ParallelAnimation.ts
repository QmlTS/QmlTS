...
const PARALLELANIMATION_META: TypeMetadata = {
  typeName: 'ParallelAnimation',
  properties: [
...
export function ParallelAnimation(): ParallelAnimationBuilder {
  return createFluentBuilder('ParallelAnimation', PARALLELANIMATION_META) as unknown as ParallelAnimationBuilder;
}
