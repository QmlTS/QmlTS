...
export interface MouseAreaBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): MouseAreaBuilder;
  ...
  onAcceptedButtonsChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onCanceled(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onClicked(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onClipChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onContainsPressChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onCursorShapeChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onDoubleClicked(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onEntered(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onExited(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onMouseXChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onMouseYChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onParentChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPressAndHold(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPressAndHoldIntervalChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPressed(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPressedButtonsChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPressedChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPreventStealingChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onPropagateComposedEventsChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onReleased(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onScrollGestureEnabledChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onStateChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onWheel(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onXChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onYChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
  onZChanged(handler: DslSignalHandlerValue): MouseAreaBuilder;
