...
const PROPERTYACTION_META: TypeMetadata = {
  typeName: 'PropertyAction',
  properties: [
...
export function PropertyAction(): PropertyActionBuilder {
  return createFluentBuilder('PropertyAction', PROPERTYACTION_META) as unknown as PropertyActionBuilder;
}
