...
export interface PinchHandlerBuilder {
  ...
  acceptedDevices(value: QmlEnumToken): PinchHandlerBuilder;
  acceptedDevicesBind(expr: string): PinchHandlerBuilder;
  acceptedModifiers(value: QmlEnumToken): PinchHandlerBuilder;
  acceptedModifiersBind(expr: string): PinchHandlerBuilder;
  acceptedPointerTypes(value: QmlEnumToken): PinchHandlerBuilder;
  acceptedPointerTypesBind(expr: string): PinchHandlerBuilder;
  cursorShape(value: QmlEnumToken): PinchHandlerBuilder;
  ...
  grabPermissions(value: QmlEnumToken): PinchHandlerBuilder;
...
const PINCHHANDLER_META: TypeMetadata = {
  typeName: 'PinchHandler',
  properties: [
    ...
    { name: 'maximumRotation', hasValue: true, hasBinding: true },
    { name: 'maximumScale', hasValue: true, hasBinding: true },
    { name: 'minimumPointCount', hasValue: true, hasBinding: true },
    { name: 'minimumRotation', hasValue: true, hasBinding: true },
    { name: 'minimumScale', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'parent', hasValue: true, hasBinding: true },
    { name: 'persistentRotation', hasValue: true, hasBinding: true },
    { name: 'persistentScale', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onMaximumRotationChanged', paramCount: 0 },
    { handlerName: 'onMaximumScaleChanged', paramCount: 0 },
    { handlerName: 'onMinimumPointCountChanged', paramCount: 0 },
    { handlerName: 'onMinimumRotationChanged', paramCount: 0 },
    { handlerName: 'onMinimumScaleChanged', paramCount: 0 },
...
export function PinchHandler(): PinchHandlerBuilder {
  return createFluentBuilder('PinchHandler', PINCHHANDLER_META) as unknown as PinchHandlerBuilder;
}
