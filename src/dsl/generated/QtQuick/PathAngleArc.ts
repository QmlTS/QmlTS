...
const PATHANGLEARC_META: TypeMetadata = {
  typeName: 'PathAngleArc',
  properties: [
    { name: 'centerX', hasValue: true, hasBinding: true },
    { name: 'centerY', hasValue: true, hasBinding: true },
    { name: 'moveToStart', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onMoveToStartChanged', paramCount: 0 },
...
export function PathAngleArc(): PathAngleArcBuilder {
  return createFluentBuilder('PathAngleArc', PATHANGLEARC_META) as unknown as PathAngleArcBuilder;
}
