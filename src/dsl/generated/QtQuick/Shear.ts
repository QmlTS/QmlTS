...
const SHEAR_META: TypeMetadata = {
  typeName: 'Shear',
  properties: [
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'origin', hasValue: true, hasBinding: true },
    { name: 'xAngle', hasValue: true, hasBinding: true },
    { name: 'xFactor', hasValue: true, hasBinding: true },
    { name: 'yAngle', hasValue: true, hasBinding: true },
    { name: 'yFactor', hasValue: true, hasBinding: true },
  ],
  signals: [
    { handlerName: 'onObjectNameChanged', paramCount: 1 },
    { handlerName: 'onOriginChanged', paramCount: 0 },
    { handlerName: 'onXAngleChanged', paramCount: 0 },
    { handlerName: 'onXFactorChanged', paramCount: 0 },
    { handlerName: 'onYAngleChanged', paramCount: 0 },
    { handlerName: 'onYFactorChanged', paramCount: 0 },
  ],
  grouped: [],
  attached: [
    {
...
export function Shear(): ShearBuilder {
  return createFluentBuilder('Shear', SHEAR_META) as unknown as ShearBuilder;
}
