...
export interface ListViewBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ListViewBuilder;
  ...
  onAcceptedButtonsChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAddDisplacedTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAddTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAtXBeginningChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAtXEndChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAtYBeginningChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onAtYEndChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onBoundsBehaviorChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onBoundsMovementChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onCacheBufferChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onContentXChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onContentYChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onCountChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onCurrentSectionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDelegateModelAccessChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDisplacedTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDisplayMarginBeginningChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDisplayMarginEndChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDragEnded(handler: DslSignalHandlerValue): ListViewBuilder;
  onDragStarted(handler: DslSignalHandlerValue): ListViewBuilder;
  onDraggingChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDraggingHorizontallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onDraggingVerticallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onEffectiveLayoutDirectionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickDecelerationChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickEnded(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickStarted(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickableDirectionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickingChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickingHorizontallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFlickingVerticallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFooterChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFooterItemChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onFooterPositioningChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHeaderChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHeaderItemChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHeaderPositioningChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightFollowsCurrentItemChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightItemChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightMoveDurationChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightMoveVelocityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightRangeModeChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightResizeDurationChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHighlightResizeVelocityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHorizontalOvershootChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onHorizontalVelocityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onInteractiveChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onIsAtBoundaryChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onKeyNavigationEnabledChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onKeyNavigationWrapsChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onLayoutDirectionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMaximumFlickVelocityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onModelChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMoveDisplacedTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMoveTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMovementEnded(handler: DslSignalHandlerValue): ListViewBuilder;
  onMovementStarted(handler: DslSignalHandlerValue): ListViewBuilder;
  onMovingChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMovingHorizontallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onMovingVerticallyChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onOrientationChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onOriginXChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onOriginYChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ListViewBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPixelAlignedChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPopulateTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPreferredHighlightBeginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPreferredHighlightEndChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onPressDelayChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onReboundChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onRemoveDisplacedTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onRemoveTransitionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onReuseItemsChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onSnapModeChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onSynchronousDragChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onVerticalLayoutDirectionChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onVerticalOvershootChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onVerticalVelocityChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onXChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onYChanged(handler: DslSignalHandlerValue): ListViewBuilder;
  onZChanged(handler: DslSignalHandlerValue): ListViewBuilder;
