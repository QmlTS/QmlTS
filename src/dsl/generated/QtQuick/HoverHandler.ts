...
export interface HoverHandlerBuilder {
  ...
  acceptedDevices(value: QmlEnumToken): HoverHandlerBuilder;
  acceptedDevicesBind(expr: string): HoverHandlerBuilder;
  acceptedModifiers(value: QmlEnumToken): HoverHandlerBuilder;
  acceptedModifiersBind(expr: string): HoverHandlerBuilder;
  acceptedPointerTypes(value: QmlEnumToken): HoverHandlerBuilder;
  ...
  cursorShape(value: QmlEnumToken): HoverHandlerBuilder;
  ...
  grabPermissions(value: QmlEnumToken): HoverHandlerBuilder;
...
const HOVERHANDLER_META: TypeMetadata = {
  typeName: 'HoverHandler',
  properties: [
...
export function HoverHandler(): HoverHandlerBuilder {
  return createFluentBuilder('HoverHandler', HOVERHANDLER_META) as unknown as HoverHandlerBuilder;
}
