...
const STATECHANGESCRIPT_META: TypeMetadata = {
  typeName: 'StateChangeScript',
  properties: [
    { name: 'name', hasValue: true, hasBinding: true },
    { name: 'objectName', hasValue: true, hasBinding: true },
    { name: 'script', hasValue: true, hasBinding: true },
  ],
  signals: [
...
export function StateChangeScript(): StateChangeScriptBuilder {
  return createFluentBuilder('StateChangeScript', STATECHANGESCRIPT_META) as unknown as StateChangeScriptBuilder;
}
