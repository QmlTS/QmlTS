...
const SEQUENTIALANIMATION_META: TypeMetadata = {
  typeName: 'SequentialAnimation',
  properties: [
...
export function SequentialAnimation(): SequentialAnimationBuilder {
  return createFluentBuilder('SequentialAnimation', SEQUENTIALANIMATION_META) as unknown as SequentialAnimationBuilder;
}
