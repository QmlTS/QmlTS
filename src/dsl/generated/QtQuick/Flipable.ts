...
export interface FlipableBuilder {
  ...
  focusPolicy(value: QmlEnumToken): FlipableBuilder;
  ...
  transformOrigin(value: QmlEnumToken): FlipableBuilder;
...
const FLIPABLE_META: TypeMetadata = {
  typeName: 'Flipable',
  properties: [
    { name: 'activeFocusOnTab', hasValue: true, hasBinding: true },
    { name: 'antialiasing', hasValue: true, hasBinding: true },
    { name: 'back', hasValue: true, hasBinding: true },
    ...
    { name: 'front', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onBackChanged', paramCount: 0 },
    ...
    { handlerName: 'onFrontChanged', paramCount: 0 },
    ...
    { handlerName: 'onSideChanged', paramCount: 0 },
...
export function Flipable(): FlipableBuilder {
  return createFluentBuilder('Flipable', FLIPABLE_META) as unknown as FlipableBuilder;
}
