...
export interface Scatter3DBuilder {
  ...
  onInputHandlerChanged(handler: DslSignalHandlerValue): Scatter3DBuilder;
  ...
  onOptimizationHintsChanged(handler: DslSignalHandlerValue): Scatter3DBuilder;
  ...
  onReflectionChanged(handler: DslSignalHandlerValue): Scatter3DBuilder;
  onReflectivityChanged(handler: DslSignalHandlerValue): Scatter3DBuilder;
