...
export interface Surface3DBuilder {
  ...
  onInputHandlerChanged(handler: DslSignalHandlerValue): Surface3DBuilder;
  ...
  onOptimizationHintsChanged(handler: DslSignalHandlerValue): Surface3DBuilder;
  ...
  onReflectionChanged(handler: DslSignalHandlerValue): Surface3DBuilder;
  onReflectivityChanged(handler: DslSignalHandlerValue): Surface3DBuilder;
