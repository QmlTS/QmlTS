...
export interface Bars3DBuilder {
  ...
  onInputHandlerChanged(handler: DslSignalHandlerValue): Bars3DBuilder;
  ...
  onOptimizationHintsChanged(handler: DslSignalHandlerValue): Bars3DBuilder;
  ...
  onReflectionChanged(handler: DslSignalHandlerValue): Bars3DBuilder;
  onReflectivityChanged(handler: DslSignalHandlerValue): Bars3DBuilder;
