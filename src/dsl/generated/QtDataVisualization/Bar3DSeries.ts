...
export interface Bar3DSeriesBuilder {
  ...
  baseGradient(value: ColorGradientBuilder): Bar3DSeriesBuilder;
  ...
  multiHighlightGradient(value: ColorGradientBuilder): Bar3DSeriesBuilder;
  ...
  singleHighlightGradient(value: ColorGradientBuilder): Bar3DSeriesBuilder;
