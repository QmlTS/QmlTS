...
export interface ColorInputsImplBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ColorInputsImplBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onColorChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onColorModified(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onCountChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onCurrentModeChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onDelegateChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onHslChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onShowAlphaChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onStateChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onXChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onYChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
  onZChanged(handler: DslSignalHandlerValue): ColorInputsImplBuilder;
