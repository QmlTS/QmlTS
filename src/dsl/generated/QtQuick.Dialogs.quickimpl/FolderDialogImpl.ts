...
export interface FolderDialogImplBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): FolderDialogImplBuilder;
  ...
  onAboutToHide(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onAboutToShow(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onAccepted(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onApplied(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onClipChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onClosePolicyChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onClosed(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onCurrentFolderChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onDimChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onDiscarded(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onEnterChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onExitChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onFontChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onFooterChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onHeaderChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onHelpRequested(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitFooterHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitFooterWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitHeaderHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitHeaderWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onMarginsChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onModalChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onNameFiltersChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onOpened(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onOpenedChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onParentChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onPopupTypeChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onRejected(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onReset(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onResultChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onSelectedFolderChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onStandardButtonsChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onXChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onYChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
  onZChanged(handler: DslSignalHandlerValue): FolderDialogImplBuilder;
