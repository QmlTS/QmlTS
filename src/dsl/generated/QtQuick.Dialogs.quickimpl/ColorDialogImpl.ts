...
export interface ColorDialogImplBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): ColorDialogImplBuilder;
  ...
  onAboutToHide(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onAboutToShow(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onAccepted(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onActiveFocusChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onApplied(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onBottomMarginChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onClipChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onClosePolicyChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onClosed(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onColorChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onDimChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onDiscarded(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onEnterChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onExitChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onFontChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onFooterChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onHeaderChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onHelpRequested(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitFooterHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitFooterWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitHeaderHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitHeaderWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onLeftMarginChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onMarginsChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onModalChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onOpened(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onOpenedChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onParentChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onPopupTypeChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onRejected(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onReset(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onResultChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onRightMarginChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onSpecChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onStandardButtonsChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onTitleChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onTopMarginChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onXChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onYChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
  onZChanged(handler: DslSignalHandlerValue): ColorDialogImplBuilder;
