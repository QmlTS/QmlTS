...
export interface FontDialogImplBuilder {
  ...
  onAboutToHide(body: string): FontDialogImplBuilder;
  onAboutToShow(body: string): FontDialogImplBuilder;
  onAccepted(body: string): FontDialogImplBuilder;
  onActiveFocusChanged(body: string): FontDialogImplBuilder;
  onApplied(body: string): FontDialogImplBuilder;
  onAvailableHeightChanged(body: string): FontDialogImplBuilder;
  onAvailableWidthChanged(body: string): FontDialogImplBuilder;
  onBackgroundChanged(body: string): FontDialogImplBuilder;
  onBottomInsetChanged(body: string): FontDialogImplBuilder;
  onBottomMarginChanged(body: string): FontDialogImplBuilder;
  onBottomPaddingChanged(body: string): FontDialogImplBuilder;
  onClipChanged(body: string): FontDialogImplBuilder;
  onClosePolicyChanged(body: string): FontDialogImplBuilder;
  onClosed(body: string): FontDialogImplBuilder;
  onContentChildrenChanged(body: string): FontDialogImplBuilder;
  onContentHeightChanged(body: string): FontDialogImplBuilder;
  onContentItemChanged(body: string): FontDialogImplBuilder;
  onContentWidthChanged(body: string): FontDialogImplBuilder;
  onCurrentFontChanged(body: string): FontDialogImplBuilder;
  onDimChanged(body: string): FontDialogImplBuilder;
  onDiscarded(body: string): FontDialogImplBuilder;
  onEnabledChanged(body: string): FontDialogImplBuilder;
  onEnterChanged(body: string): FontDialogImplBuilder;
  onExitChanged(body: string): FontDialogImplBuilder;
  onFocusChanged(body: string): FontDialogImplBuilder;
  onFontChanged(body: string): FontDialogImplBuilder;
  onFooterChanged(body: string): FontDialogImplBuilder;
  onHeaderChanged(body: string): FontDialogImplBuilder;
  onHeightChanged(body: string): FontDialogImplBuilder;
  onHelpRequested(body: string): FontDialogImplBuilder;
  onHorizontalPaddingChanged(body: string): FontDialogImplBuilder;
  onImplicitBackgroundHeightChanged(body: string): FontDialogImplBuilder;
  onImplicitBackgroundWidthChanged(body: string): FontDialogImplBuilder;
  onImplicitContentHeightChanged(body: string): FontDialogImplBuilder;
  onImplicitContentWidthChanged(body: string): FontDialogImplBuilder;
  onImplicitFooterHeightChanged(body: string): FontDialogImplBuilder;
  onImplicitFooterWidthChanged(body: string): FontDialogImplBuilder;
  onImplicitHeaderHeightChanged(body: string): FontDialogImplBuilder;
  onImplicitHeaderWidthChanged(body: string): FontDialogImplBuilder;
  onImplicitHeightChanged(body: string): FontDialogImplBuilder;
  onImplicitWidthChanged(body: string): FontDialogImplBuilder;
  onLeftInsetChanged(body: string): FontDialogImplBuilder;
  onLeftMarginChanged(body: string): FontDialogImplBuilder;
  onLeftPaddingChanged(body: string): FontDialogImplBuilder;
  onLocaleChanged(body: string): FontDialogImplBuilder;
  onMarginsChanged(body: string): FontDialogImplBuilder;
  onMirroredChanged(body: string): FontDialogImplBuilder;
  onModalChanged(body: string): FontDialogImplBuilder;
  onObjectNameChanged(body: string): FontDialogImplBuilder;
  onOpacityChanged(body: string): FontDialogImplBuilder;
  onOpened(body: string): FontDialogImplBuilder;
  onOpenedChanged(body: string): FontDialogImplBuilder;
  onOptionsChanged(body: string): FontDialogImplBuilder;
  onPaddingChanged(body: string): FontDialogImplBuilder;
  onPaletteChanged(body: string): FontDialogImplBuilder;
  onPaletteCreated(body: string): FontDialogImplBuilder;
  onParentChanged(body: string): FontDialogImplBuilder;
  onPopupTypeChanged(body: string): FontDialogImplBuilder;
  onRejected(body: string): FontDialogImplBuilder;
  onReset(body: string): FontDialogImplBuilder;
  onResultChanged(body: string): FontDialogImplBuilder;
  onRightInsetChanged(body: string): FontDialogImplBuilder;
  onRightMarginChanged(body: string): FontDialogImplBuilder;
  onRightPaddingChanged(body: string): FontDialogImplBuilder;
  onScaleChanged(body: string): FontDialogImplBuilder;
  onSpacingChanged(body: string): FontDialogImplBuilder;
  onStandardButtonsChanged(body: string): FontDialogImplBuilder;
  onTitleChanged(body: string): FontDialogImplBuilder;
  onTopInsetChanged(body: string): FontDialogImplBuilder;
  onTopMarginChanged(body: string): FontDialogImplBuilder;
  onTopPaddingChanged(body: string): FontDialogImplBuilder;
  onVerticalPaddingChanged(body: string): FontDialogImplBuilder;
  onVisibleChanged(body: string): FontDialogImplBuilder;
  onWidthChanged(body: string): FontDialogImplBuilder;
  onWindowChanged(body: string): FontDialogImplBuilder;
  onXChanged(body: string): FontDialogImplBuilder;
  onYChanged(body: string): FontDialogImplBuilder;
  onZChanged(body: string): FontDialogImplBuilder;
