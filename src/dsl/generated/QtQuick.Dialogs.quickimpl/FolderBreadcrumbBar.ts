...
export interface FolderBreadcrumbBarBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): FolderBreadcrumbBarBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onAvailableHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onAvailableWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onBackgroundChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onButtonDelegateChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onClipChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onContentChildrenChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onContentItemChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onCountChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onCurrentIndexChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onCurrentItemChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onDialogChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onFocusReasonChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onFontChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onHorizontalPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onHoverEnabledChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onHoveredChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitBackgroundHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitBackgroundWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitContentHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitContentWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onLocaleChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onMirroredChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onParentChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onSeparatorDelegateChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onSpacingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onStateChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onTextFieldChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onUpButtonChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onUpButtonSpacingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onVerticalPaddingChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onVisualFocusChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onWheelEnabledChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onXChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onYChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
  onZChanged(handler: DslSignalHandlerValue): FolderBreadcrumbBarBuilder;
