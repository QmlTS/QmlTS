...
export namespace PdfLinkModel {
  export namespace CheckIndexOption {
    ...
    export const DoNotUseParent = createEnumToken('PdfLinkModel', 'CheckIndexOption', 'DoNotUseParent');
    export const ParentIsInvalid = createEnumToken('PdfLinkModel', 'CheckIndexOption', 'ParentIsInvalid');
  }
  export namespace LayoutChangeHint {
    export const NoLayoutChangeHint = createEnumToken('PdfLinkModel', 'LayoutChangeHint', 'NoLayoutChangeHint');
    export const VerticalSortHint = createEnumToken('PdfLinkModel', 'LayoutChangeHint', 'VerticalSortHint');
    export const HorizontalSortHint = createEnumToken('PdfLinkModel', 'LayoutChangeHint', 'HorizontalSortHint');
  }
