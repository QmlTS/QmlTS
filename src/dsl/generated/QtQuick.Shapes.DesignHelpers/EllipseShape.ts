...
export interface EllipseShapeBuilder {
  ...
  onActiveFocusChanged(body: string): EllipseShapeBuilder;
  onActiveFocusOnTabChanged(body: string): EllipseShapeBuilder;
  onAntialiasingChanged(body: string): EllipseShapeBuilder;
  onAsynchronousChanged(body: string): EllipseShapeBuilder;
  onBaselineOffsetChanged(body: string): EllipseShapeBuilder;
  onBorderModeChanged(body: string): EllipseShapeBuilder;
  onBoundingRectChanged(body: string): EllipseShapeBuilder;
  onCapStyleChanged(body: string): EllipseShapeBuilder;
  onChildrenChanged(body: string): EllipseShapeBuilder;
  onChildrenRectChanged(body: string): EllipseShapeBuilder;
  onClipChanged(body: string): EllipseShapeBuilder;
  onContainmentMaskChanged(body: string): EllipseShapeBuilder;
  onContainsModeChanged(body: string): EllipseShapeBuilder;
  onCornerRadiusChanged(body: string): EllipseShapeBuilder;
  onDashOffsetChanged(body: string): EllipseShapeBuilder;
  onDashPatternChanged(body: string): EllipseShapeBuilder;
  onEnabledChanged(body: string): EllipseShapeBuilder;
  onFillColorChanged(body: string): EllipseShapeBuilder;
  onFillModeChanged(body: string): EllipseShapeBuilder;
  onFillRuleChanged(body: string): EllipseShapeBuilder;
  onFocusChanged(body: string): EllipseShapeBuilder;
  onFocusPolicyChanged(body: string): EllipseShapeBuilder;
  onGradientChanged(body: string): EllipseShapeBuilder;
  onHeightChanged(body: string): EllipseShapeBuilder;
  onHorizontalAlignmentChanged(body: string): EllipseShapeBuilder;
  onImplicitHeightChanged(body: string): EllipseShapeBuilder;
  onImplicitWidthChanged(body: string): EllipseShapeBuilder;
  onInnerArcRatioChanged(body: string): EllipseShapeBuilder;
  onJoinStyleChanged(body: string): EllipseShapeBuilder;
  onObjectNameChanged(body: string): EllipseShapeBuilder;
  onOpacityChanged(body: string): EllipseShapeBuilder;
  onPaletteChanged(body: string): EllipseShapeBuilder;
  onPaletteCreated(body: string): EllipseShapeBuilder;
  onParentChanged(body: string): EllipseShapeBuilder;
  onPreferredRendererTypeChanged(body: string): EllipseShapeBuilder;
  onRendererChanged(body: string): EllipseShapeBuilder;
  onRotationChanged(body: string): EllipseShapeBuilder;
  onScaleChanged(body: string): EllipseShapeBuilder;
  onSmoothChanged(body: string): EllipseShapeBuilder;
  onStartAngleChanged(body: string): EllipseShapeBuilder;
  onStateChanged(body: string): EllipseShapeBuilder;
  onStatusChanged(body: string): EllipseShapeBuilder;
  onStrokeColorChanged(body: string): EllipseShapeBuilder;
  onStrokeStyleChanged(body: string): EllipseShapeBuilder;
  onStrokeWidthChanged(body: string): EllipseShapeBuilder;
  onSweepAngleChanged(body: string): EllipseShapeBuilder;
  onTransformOriginChanged(body: string): EllipseShapeBuilder;
  onVendorExtensionsEnabledChanged(body: string): EllipseShapeBuilder;
  onVerticalAlignmentChanged(body: string): EllipseShapeBuilder;
  onVisibleChanged(body: string): EllipseShapeBuilder;
  onVisibleChildrenChanged(body: string): EllipseShapeBuilder;
  onWidthChanged(body: string): EllipseShapeBuilder;
  onWindowChanged(body: string): EllipseShapeBuilder;
  onXChanged(body: string): EllipseShapeBuilder;
  onYChanged(body: string): EllipseShapeBuilder;
  onZChanged(body: string): EllipseShapeBuilder;
