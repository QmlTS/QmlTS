...
export interface ItemParticleAttachedBuilder {
  ...
  onAttached(body: string): ItemParticleAttachedBuilder;
  onDetached(body: string): ItemParticleAttachedBuilder;
  onObjectNameChanged(body: string): ItemParticleAttachedBuilder;
}
