...
export function TextureRectangle(): TextureRectangleBuilder {
  return createFluentBuilder('TextureRectangle', TEXTURERECTANGLE_META) as unknown as TextureRectangleBuilder;
}

export namespace TextureRectangle {
  export namespace ComparisonFunction {
    export const CompareLessEqual = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareLessEqual');
    export const CompareGreaterEqual = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareGreaterEqual');
    export const CompareLess = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareLess');
    export const CompareGreater = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareGreater');
    export const CompareEqual = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareEqual');
    export const CommpareNotEqual = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CommpareNotEqual');
    export const CompareAlways = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareAlways');
    export const CompareNever = createEnumToken('TextureRectangle', 'ComparisonFunction', 'CompareNever');
  }
  export namespace ComparisonMode {
    export const CompareRefToTexture = createEnumToken('TextureRectangle', 'ComparisonMode', 'CompareRefToTexture');
    export const CompareNone = createEnumToken('TextureRectangle', 'ComparisonMode', 'CompareNone');
  }
  export namespace CubeMapFace {
    export const CubeMapPositiveX = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapPositiveX');
    export const CubeMapNegativeX = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapNegativeX');
    export const CubeMapPositiveY = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapPositiveY');
    export const CubeMapNegativeY = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapNegativeY');
    export const CubeMapPositiveZ = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapPositiveZ');
    export const CubeMapNegativeZ = createEnumToken('TextureRectangle', 'CubeMapFace', 'CubeMapNegativeZ');
  ...
  export namespace Filter {
    ...
    export const NearestMipMapNearest = createEnumToken('TextureRectangle', 'Filter', 'NearestMipMapNearest');
    export const NearestMipMapLinear = createEnumToken('TextureRectangle', 'Filter', 'NearestMipMapLinear');
    export const LinearMipMapNearest = createEnumToken('TextureRectangle', 'Filter', 'LinearMipMapNearest');
    export const LinearMipMapLinear = createEnumToken('TextureRectangle', 'Filter', 'LinearMipMapLinear');
  }
  export namespace HandleType {
    export const NoHandle = createEnumToken('TextureRectangle', 'HandleType', 'NoHandle');
    export const OpenGLTextureId = createEnumToken('TextureRectangle', 'HandleType', 'OpenGLTextureId');
  ...
  export namespace Target {
    ...
    export const TargetCubeMapArray = createEnumToken('TextureRectangle', 'Target', 'TargetCubeMapArray');
    export const Target2DMultisample = createEnumToken('TextureRectangle', 'Target', 'Target2DMultisample');
    export const Target2DMultisampleArray = createEnumToken('TextureRectangle', 'Target', 'Target2DMultisampleArray');
  ...
  export namespace TextureFormat {
    ...
    export const RGBA16_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RGBA16_UNorm');
    ...
    export const RGBA16_SNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RGBA16_SNorm');
    ...
    export const R_ATI1N_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'R_ATI1N_UNorm');
    export const R_ATI1N_SNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'R_ATI1N_SNorm');
    export const RG_ATI2N_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RG_ATI2N_UNorm');
    export const RG_ATI2N_SNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RG_ATI2N_SNorm');
    export const RGB_BP_UNSIGNED_FLOAT = createEnumToken('TextureRectangle', 'TextureFormat', 'RGB_BP_UNSIGNED_FLOAT');
    export const RGB_BP_SIGNED_FLOAT = createEnumToken('TextureRectangle', 'TextureFormat', 'RGB_BP_SIGNED_FLOAT');
    export const RGB_BP_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RGB_BP_UNorm');
    export const R11_EAC_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'R11_EAC_UNorm');
    export const R11_EAC_SNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'R11_EAC_SNorm');
    export const RG11_EAC_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RG11_EAC_UNorm');
    export const RG11_EAC_SNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'RG11_EAC_SNorm');
    ...
    export const RGB8_PunchThrough_Alpha1_ETC2 = createEnumToken('TextureRectangle', 'TextureFormat', 'RGB8_PunchThrough_Alpha1_ETC2');
    export const SRGB8_PunchThrough_Alpha1_ETC2 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB8_PunchThrough_Alpha1_ETC2');
    export const RGBA8_ETC2_EAC = createEnumToken('TextureRectangle', 'TextureFormat', 'RGBA8_ETC2_EAC');
    export const SRGB8_Alpha8_ETC2_EAC = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB8_Alpha8_ETC2_EAC');
    ...
    export const SRGB8_Alpha8 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB8_Alpha8');
    export const SRGB_DXT1 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB_DXT1');
    export const SRGB_Alpha_DXT1 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB_Alpha_DXT1');
    export const SRGB_Alpha_DXT3 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB_Alpha_DXT3');
    export const SRGB_Alpha_DXT5 = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB_Alpha_DXT5');
    export const SRGB_BP_UNorm = createEnumToken('TextureRectangle', 'TextureFormat', 'SRGB_BP_UNorm');
    ...
    export const LuminanceFormat = createEnumToken('TextureRectangle', 'TextureFormat', 'LuminanceFormat');
    export const LuminanceAlphaFormat = createEnumToken('TextureRectangle', 'TextureFormat', 'LuminanceAlphaFormat');
  }
}
