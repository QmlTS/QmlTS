...
export interface CameraSelectorBuilder {
  ...
  onCameraChanged(body: string): CameraSelectorBuilder;
  onEnabledChanged(body: string): CameraSelectorBuilder;
  onNodeDestroyed(body: string): CameraSelectorBuilder;
  onObjectNameChanged(body: string): CameraSelectorBuilder;
  onParentChanged(body: string): CameraSelectorBuilder;
}
...
export function CameraSelector(): CameraSelectorBuilder {
  return createFluentBuilder('CameraSelector', CAMERASELECTOR_META) as unknown as CameraSelectorBuilder;
}
