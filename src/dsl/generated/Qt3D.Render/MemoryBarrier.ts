...
export function MemoryBarrier(): MemoryBarrierBuilder {
  return createFluentBuilder('MemoryBarrier', MEMORYBARRIER_META) as unknown as MemoryBarrierBuilder;
}

export namespace MemoryBarrier {
  export namespace Operations {
    export const None = createEnumToken('MemoryBarrier', 'Operations', 'None');
    export const VertexAttributeArray = createEnumToken('MemoryBarrier', 'Operations', 'VertexAttributeArray');
    ...
    export const ShaderImageAccess = createEnumToken('MemoryBarrier', 'Operations', 'ShaderImageAccess');
    ...
    export const TransformFeedback = createEnumToken('MemoryBarrier', 'Operations', 'TransformFeedback');
