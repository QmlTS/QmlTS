...
export interface BusyIndicatorImplBuilder {
  ...
  onContentsScaleChanged(body: string): BusyIndicatorImplBuilder;
  onContentsSizeChanged(body: string): BusyIndicatorImplBuilder;
  onEnabledChanged(body: string): BusyIndicatorImplBuilder;
  onFillColorChanged(body: string): BusyIndicatorImplBuilder;
  ...
  onRenderTargetChanged(body: string): BusyIndicatorImplBuilder;
  ...
  onTextureSizeChanged(body: string): BusyIndicatorImplBuilder;
