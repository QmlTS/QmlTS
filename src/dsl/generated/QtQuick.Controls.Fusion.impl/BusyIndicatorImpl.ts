...
export interface BusyIndicatorImplBuilder {
  ...
  color(value: QmlColor): BusyIndicatorImplBuilder;
  colorBind(expr: string): BusyIndicatorImplBuilder;
  containmentMask(value: QtObjectBuilder): BusyIndicatorImplBuilder;
  containmentMaskBind(expr: string): BusyIndicatorImplBuilder;
  contentsScale(value: number): BusyIndicatorImplBuilder;
  contentsScaleBind(expr: string): BusyIndicatorImplBuilder;
  contentsSize(value: QmlSize): BusyIndicatorImplBuilder;
  contentsSizeBind(expr: string): BusyIndicatorImplBuilder;
  enabled(value: boolean): BusyIndicatorImplBuilder;
  enabledBind(expr: string): BusyIndicatorImplBuilder;
  fillColor(value: QmlColor): BusyIndicatorImplBuilder;
  fillColorBind(expr: string): BusyIndicatorImplBuilder;
  ...
  renderTarget(value: QmlEnumToken): BusyIndicatorImplBuilder;
  renderTargetBind(expr: string): BusyIndicatorImplBuilder;
  ...
  textureSize(value: QmlSize): BusyIndicatorImplBuilder;
  textureSizeBind(expr: string): BusyIndicatorImplBuilder;
  ...
  onContentsScaleChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
  onContentsSizeChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
  onFillColorChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
  ...
  onRenderTargetChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
  ...
  onTextureSizeChanged(handler: DslSignalHandlerValue): BusyIndicatorImplBuilder;
