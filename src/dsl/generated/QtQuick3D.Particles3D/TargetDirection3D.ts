...
export interface TargetDirection3DBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): TargetDirection3DBuilder;
  ...
  onMagnitudeChanged(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
  onMagnitudeChangedVariation(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
  onNormalizedChanged(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
  onPositionChanged(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
  onPositionVariationChanged(handler: DslSignalHandlerValue): TargetDirection3DBuilder;
}
