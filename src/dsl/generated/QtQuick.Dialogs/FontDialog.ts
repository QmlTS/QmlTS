...
export interface FontDialogBuilder {
  ...
  popupType(value: QmlEnumToken): FontDialogBuilder;
  popupTypeBind(expr: string): FontDialogBuilder;
  result(value: number): FontDialogBuilder;
  resultBind(expr: string): FontDialogBuilder;
  selectedFont(value: QmlFont): FontDialogBuilder;
  selectedFontBind(expr: string): FontDialogBuilder;
  ...
  onPopupTypeChanged(handler: DslSignalHandlerValue): FontDialogBuilder;
  ...
  onSelectedFontChanged(handler: DslSignalHandlerValue): FontDialogBuilder;
...
const FONTDIALOG_META: TypeMetadata = {
  ...
  properties: [
    ...
    { name: 'selectedFont', hasValue: true, hasBinding: true },
  ...
  signals: [
    ...
    { handlerName: 'onSelectedFontChanged', paramCount: 0 },
