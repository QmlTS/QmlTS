...
export interface FileDialogBuilder {
  ...
  onCurrentFolderChanged(body: string): FileDialogBuilder;
  ...
  onPopupTypeChanged(body: string): FileDialogBuilder;
  ...
  onSelectedFileChanged(body: string): FileDialogBuilder;
  onSelectedFilesChanged(body: string): FileDialogBuilder;
