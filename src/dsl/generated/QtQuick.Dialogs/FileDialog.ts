...
import type { SelectedNameFilterBuilder } from '../QtQuick.Dialogs.quickimpl/QQuickFileNameFilter.js';
export interface FileDialogBuilder {
  ...
  currentFolder(value: QmlUrl): FileDialogBuilder;
  currentFolderBind(expr: string): FileDialogBuilder;
  ...
  popupType(value: QmlEnumToken): FileDialogBuilder;
  popupTypeBind(expr: string): FileDialogBuilder;
  ...
  selectedFile(value: QmlUrl): FileDialogBuilder;
  selectedFileBind(expr: string): FileDialogBuilder;
  ...
  onCurrentFolderChanged(handler: DslSignalHandlerValue): FileDialogBuilder;
  ...
  onPopupTypeChanged(handler: DslSignalHandlerValue): FileDialogBuilder;
  ...
  onSelectedFileChanged(handler: DslSignalHandlerValue): FileDialogBuilder;
  onSelectedFilesChanged(handler: DslSignalHandlerValue): FileDialogBuilder;
...
const FILEDIALOG_META: TypeMetadata = {
  ...
  signals: [
    ...
    { handlerName: 'onSelectedFileChanged', paramCount: 0 },
    { handlerName: 'onSelectedFilesChanged', paramCount: 0 },
