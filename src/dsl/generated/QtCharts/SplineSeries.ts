...
export interface SplineSeriesBuilder {
  ...
  axisRadial(value: QmlValue): SplineSeriesBuilder;
  axisRadialBind(expr: string): SplineSeriesBuilder;
  axisX(value: QmlValue): SplineSeriesBuilder;
  axisXBind(expr: string): SplineSeriesBuilder;
  axisXTop(value: QmlValue): SplineSeriesBuilder;
  axisXTopBind(expr: string): SplineSeriesBuilder;
  axisY(value: QmlValue): SplineSeriesBuilder;
  axisYBind(expr: string): SplineSeriesBuilder;
  axisYRight(value: QmlValue): SplineSeriesBuilder;
  axisYRightBind(expr: string): SplineSeriesBuilder;
  ...
  style(value: QmlEnumToken): SplineSeriesBuilder;
  styleBind(expr: string): SplineSeriesBuilder;
