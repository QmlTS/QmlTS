...
export interface LineSeriesBuilder {
  ...
  onAxisAngularChanged(body: string): LineSeriesBuilder;
  onAxisRadialChanged(body: string): LineSeriesBuilder;
  onAxisXChanged(body: string): LineSeriesBuilder;
  onAxisXTopChanged(body: string): LineSeriesBuilder;
  onAxisYChanged(body: string): LineSeriesBuilder;
  onAxisYRightChanged(body: string): LineSeriesBuilder;
  ...
  onStyleChanged(body: string): LineSeriesBuilder;
