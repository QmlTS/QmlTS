...
export interface LineSeriesBuilder {
  ...
  axisAngular(value: QmlValue): LineSeriesBuilder;
  axisAngularBind(expr: string): LineSeriesBuilder;
  axisRadial(value: QmlValue): LineSeriesBuilder;
  axisRadialBind(expr: string): LineSeriesBuilder;
  axisX(value: QmlValue): LineSeriesBuilder;
  axisXBind(expr: string): LineSeriesBuilder;
  axisXTop(value: QmlValue): LineSeriesBuilder;
  axisXTopBind(expr: string): LineSeriesBuilder;
  axisY(value: QmlValue): LineSeriesBuilder;
  axisYBind(expr: string): LineSeriesBuilder;
  axisYRight(value: QmlValue): LineSeriesBuilder;
  axisYRightBind(expr: string): LineSeriesBuilder;
  ...
  style(value: QmlEnumToken): LineSeriesBuilder;
  styleBind(expr: string): LineSeriesBuilder;
  ...
  onAxisAngularChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  onAxisRadialChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  onAxisXChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  onAxisXTopChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  onAxisYChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  onAxisYRightChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
  ...
  onStyleChanged(handler: DslSignalHandlerValue): LineSeriesBuilder;
...
const LINESERIES_META: TypeMetadata = {
  ...
  signals: [
    ...
    { handlerName: 'onCapStyleChanged', paramCount: 1 },
