...
export interface PieSeriesBuilder {
  ...
  onSliceAdded(handler: DslSignalHandlerValue): PieSeriesBuilder;
  onSliceRemoved(handler: DslSignalHandlerValue): PieSeriesBuilder;
...
const PIESERIES_META: TypeMetadata = {
  ...
  signals: [
    ...
    { handlerName: 'onSliceAdded', paramCount: 1 },
    { handlerName: 'onSliceRemoved', paramCount: 1 },
