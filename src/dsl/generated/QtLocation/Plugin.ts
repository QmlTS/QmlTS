...
export namespace Plugin {
  export namespace GeocodingFeature {
    export const NoGeocodingFeatures = createEnumToken(
      'Plugin',
      'GeocodingFeature',
      'NoGeocodingFeatures',
    );
    export const OnlineGeocodingFeature = createEnumToken(
      'Plugin',
      'GeocodingFeature',
      'OnlineGeocodingFeature',
    );
    export const OfflineGeocodingFeature = createEnumToken(
      'Plugin',
      'GeocodingFeature',
      'OfflineGeocodingFeature',
    );
    export const ReverseGeocodingFeature = createEnumToken(
      'Plugin',
      'GeocodingFeature',
      'ReverseGeocodingFeature',
    );
    export const LocalizedGeocodingFeature = createEnumToken(
      'Plugin',
      'GeocodingFeature',
      'LocalizedGeocodingFeature',
    );
    export const AnyGeocodingFeatures = createEnumToken(
      'Plugin',
      'GeocodingFeature',
  ...
  export namespace MappingFeature {
    export const NoMappingFeatures = createEnumToken(
      'Plugin',
      'MappingFeature',
      'NoMappingFeatures',
    );
    export const OnlineMappingFeature = createEnumToken(
      'Plugin',
      'MappingFeature',
      'OnlineMappingFeature',
    );
    export const OfflineMappingFeature = createEnumToken(
      'Plugin',
      'MappingFeature',
      'OfflineMappingFeature',
    );
    export const LocalizedMappingFeature = createEnumToken(
      'Plugin',
      'MappingFeature',
      'LocalizedMappingFeature',
    );
    export const AnyMappingFeatures = createEnumToken(
      'Plugin',
      'MappingFeature',
      'AnyMappingFeatures',
    );
  ...
  export namespace NavigationFeatures {
    export const NoNavigationFeatures = createEnumToken(
      'Plugin',
      'NavigationFeatures',
      'NoNavigationFeatures',
    );
    export const OnlineNavigationFeature = createEnumToken(
      'Plugin',
      'NavigationFeatures',
      'OnlineNavigationFeature',
    );
    export const OfflineNavigationFeature = createEnumToken(
      'Plugin',
      'NavigationFeatures',
      'OfflineNavigationFeature',
    );
    export const AnyNavigationFeatures = createEnumToken(
      'Plugin',
      'NavigationFeatures',
  ...
  export namespace PlacesFeature {
    ...
    export const OnlinePlacesFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'OnlinePlacesFeature',
    );
    export const OfflinePlacesFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'OfflinePlacesFeature',
    );
    export const SavePlaceFeature = createEnumToken('Plugin', 'PlacesFeature', 'SavePlaceFeature');
    export const RemovePlaceFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'RemovePlaceFeature',
    );
    export const SaveCategoryFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'SaveCategoryFeature',
    );
    export const RemoveCategoryFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'RemoveCategoryFeature',
    );
    export const PlaceRecommendationsFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'PlaceRecommendationsFeature',
    );
    export const SearchSuggestionsFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'SearchSuggestionsFeature',
    );
    export const LocalizedPlacesFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'LocalizedPlacesFeature',
    );
    export const NotificationsFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'NotificationsFeature',
    );
    export const PlaceMatchingFeature = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'PlaceMatchingFeature',
    );
    export const AnyPlacesFeatures = createEnumToken(
      'Plugin',
      'PlacesFeature',
      'AnyPlacesFeatures',
    );
  ...
  export namespace RoutingFeature {
    export const NoRoutingFeatures = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'NoRoutingFeatures',
    );
    export const OnlineRoutingFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'OnlineRoutingFeature',
    );
    export const OfflineRoutingFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'OfflineRoutingFeature',
    );
    export const LocalizedRoutingFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'LocalizedRoutingFeature',
    );
    export const RouteUpdatesFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'RouteUpdatesFeature',
    );
    export const AlternativeRoutesFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'AlternativeRoutesFeature',
    );
    export const ExcludeAreasRoutingFeature = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'ExcludeAreasRoutingFeature',
    );
    export const AnyRoutingFeatures = createEnumToken(
      'Plugin',
      'RoutingFeature',
      'AnyRoutingFeatures',
    );
