...
import type { QmlColor, QmlEnumToken, QmlObjectBuilder, QmlRect, QmlValue, TypeMetadata } from '../../runtime/index.js';
...
export interface MapBuilder {
  ...
  onActiveFocusChanged(body: string): MapBuilder;
  onActiveFocusOnTabChanged(body: string): MapBuilder;
  onActiveMapTypeChanged(body: string): MapBuilder;
  onAntialiasingChanged(body: string): MapBuilder;
  onBaselineOffsetChanged(body: string): MapBuilder;
  onBearingChanged(body: string): MapBuilder;
  onCenterChanged(body: string): MapBuilder;
  onChildrenChanged(body: string): MapBuilder;
  onChildrenRectChanged(body: string): MapBuilder;
  onClipChanged(body: string): MapBuilder;
  onColorChanged(body: string): MapBuilder;
  onContainmentMaskChanged(body: string): MapBuilder;
  onCopyrightLinkActivated(body: string): MapBuilder;
  onCopyrightsChanged(body: string): MapBuilder;
  onCopyrightsImageChanged(body: string): MapBuilder;
  onCopyrightsVisibleChanged(body: string): MapBuilder;
  onEnabledChanged(body: string): MapBuilder;
  onErrorChanged(body: string): MapBuilder;
  onFieldOfViewChanged(body: string): MapBuilder;
  onFocusChanged(body: string): MapBuilder;
  onFocusPolicyChanged(body: string): MapBuilder;
  onHeightChanged(body: string): MapBuilder;
  onImplicitHeightChanged(body: string): MapBuilder;
  onImplicitWidthChanged(body: string): MapBuilder;
  onMapItemsChanged(body: string): MapBuilder;
  onMapReadyChanged(body: string): MapBuilder;
  onMaximumFieldOfViewChanged(body: string): MapBuilder;
  onMaximumTiltChanged(body: string): MapBuilder;
  onMaximumZoomLevelChanged(body: string): MapBuilder;
  onMinimumFieldOfViewChanged(body: string): MapBuilder;
  onMinimumTiltChanged(body: string): MapBuilder;
  onMinimumZoomLevelChanged(body: string): MapBuilder;
  onObjectNameChanged(body: string): MapBuilder;
  onOpacityChanged(body: string): MapBuilder;
  onPaletteChanged(body: string): MapBuilder;
  onPaletteCreated(body: string): MapBuilder;
  onParentChanged(body: string): MapBuilder;
  onPluginChanged(body: string): MapBuilder;
  onRotationChanged(body: string): MapBuilder;
  onScaleChanged(body: string): MapBuilder;
  onSmoothChanged(body: string): MapBuilder;
  onStateChanged(body: string): MapBuilder;
  onSupportedMapTypesChanged(body: string): MapBuilder;
  onTiltChanged(body: string): MapBuilder;
  onTransformOriginChanged(body: string): MapBuilder;
  onVisibleAreaChanged(body: string): MapBuilder;
  onVisibleChanged(body: string): MapBuilder;
  onVisibleChildrenChanged(body: string): MapBuilder;
  onVisibleRegionChanged(body: string): MapBuilder;
  onWidthChanged(body: string): MapBuilder;
  onWindowChanged(body: string): MapBuilder;
  onXChanged(body: string): MapBuilder;
  onYChanged(body: string): MapBuilder;
  onZChanged(body: string): MapBuilder;
  onZoomLevelChanged(body: string): MapBuilder;
...
export namespace Map {
  export namespace Flags {
    export const ItemClipsChildrenToShape = createEnumToken('Map', 'Flags', 'ItemClipsChildrenToShape');
  ...
  export namespace ItemChange {
    export const ItemChildAddedChange = createEnumToken('Map', 'ItemChange', 'ItemChildAddedChange');
    export const ItemChildRemovedChange = createEnumToken('Map', 'ItemChange', 'ItemChildRemovedChange');
    export const ItemSceneChange = createEnumToken('Map', 'ItemChange', 'ItemSceneChange');
    export const ItemVisibleHasChanged = createEnumToken('Map', 'ItemChange', 'ItemVisibleHasChanged');
    export const ItemParentHasChanged = createEnumToken('Map', 'ItemChange', 'ItemParentHasChanged');
    export const ItemOpacityHasChanged = createEnumToken('Map', 'ItemChange', 'ItemOpacityHasChanged');
    export const ItemActiveFocusHasChanged = createEnumToken('Map', 'ItemChange', 'ItemActiveFocusHasChanged');
    export const ItemRotationHasChanged = createEnumToken('Map', 'ItemChange', 'ItemRotationHasChanged');
    export const ItemAntialiasingHasChanged = createEnumToken('Map', 'ItemChange', 'ItemAntialiasingHasChanged');
    export const ItemDevicePixelRatioHasChanged = createEnumToken('Map', 'ItemChange', 'ItemDevicePixelRatioHasChanged');
    export const ItemEnabledHasChanged = createEnumToken('Map', 'ItemChange', 'ItemEnabledHasChanged');
    export const ItemScaleHasChanged = createEnumToken('Map', 'ItemChange', 'ItemScaleHasChanged');
    export const ItemTransformHasChanged = createEnumToken('Map', 'ItemChange', 'ItemTransformHasChanged');
  }
