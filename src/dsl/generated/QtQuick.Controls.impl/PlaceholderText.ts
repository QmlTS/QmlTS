...
export interface PlaceholderTextBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): PlaceholderTextBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onBaseUrlChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onClipChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onColorChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onContentHeightChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onContentSizeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onContentWidthChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onEffectiveHorizontalAlignmentChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onElideModeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onFontChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onFontInfoChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onFontSizeModeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLineCountChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLineHeightChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLineHeightModeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLineLaidOut(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLinkActivated(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLinkColorChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onLinkHovered(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onMaximumLineCountChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onMinimumPixelSizeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onMinimumPointSizeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onPaddingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onParentChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onRenderTypeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onRenderTypeQualityChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onStateChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onStyleChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onStyleColorChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onTextChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onTextFormatChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onTruncatedChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onWrapModeChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onXChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onYChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
  onZChanged(handler: DslSignalHandlerValue): PlaceholderTextBuilder;
