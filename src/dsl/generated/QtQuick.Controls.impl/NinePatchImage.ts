...
export interface NinePatchImageBuilder {
  ...
  children(...objs: QmlObjectBuilder[]): NinePatchImageBuilder;
  ...
  onActiveFocusChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onActiveFocusOnTabChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onAntialiasingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onAsynchronousChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onAutoTransformChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onBaselineOffsetChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onBottomInsetChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onBottomPaddingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onCacheChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onChildrenChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onChildrenRectChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onClipChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onColorSpaceChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onContainmentMaskChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onCurrentFrameChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onEnabledChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onFillModeChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onFocusChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onFocusPolicyChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onFrameCountChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onHeightChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onHorizontalAlignmentChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onImplicitHeightChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onImplicitWidthChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onLeftInsetChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onLeftPaddingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onMipmapChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onMirrorChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onMirrorVerticallyChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onObjectNameChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onOpacityChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onPaintedGeometryChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onPaletteChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onPaletteCreated(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onParentChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onProgressChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onRetainWhileLoadingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onRightInsetChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onRightPaddingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onRotationChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onScaleChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onSmoothChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onSourceChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onSourceClipRectChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onSourceSizeChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onStateChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onStatusChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onTopInsetChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onTopPaddingChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onTransformOriginChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onVerticalAlignmentChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onVisibleChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onVisibleChildrenChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onWidthChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onWindowChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onXChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onYChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
  onZChanged(handler: DslSignalHandlerValue): NinePatchImageBuilder;
