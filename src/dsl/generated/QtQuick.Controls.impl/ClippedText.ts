...
export interface ClippedTextBuilder {
  ...
  onActiveFocusChanged(body: string): ClippedTextBuilder;
  onActiveFocusOnTabChanged(body: string): ClippedTextBuilder;
  onAntialiasingChanged(body: string): ClippedTextBuilder;
  onBaseUrlChanged(body: string): ClippedTextBuilder;
  onBaselineOffsetChanged(body: string): ClippedTextBuilder;
  onBottomPaddingChanged(body: string): ClippedTextBuilder;
  onChildrenChanged(body: string): ClippedTextBuilder;
  onChildrenRectChanged(body: string): ClippedTextBuilder;
  onClipChanged(body: string): ClippedTextBuilder;
  onColorChanged(body: string): ClippedTextBuilder;
  onContainmentMaskChanged(body: string): ClippedTextBuilder;
  onContentHeightChanged(body: string): ClippedTextBuilder;
  onContentSizeChanged(body: string): ClippedTextBuilder;
  onContentWidthChanged(body: string): ClippedTextBuilder;
  onEffectiveHorizontalAlignmentChanged(body: string): ClippedTextBuilder;
  onElideModeChanged(body: string): ClippedTextBuilder;
  onEnabledChanged(body: string): ClippedTextBuilder;
  onFocusChanged(body: string): ClippedTextBuilder;
  onFocusPolicyChanged(body: string): ClippedTextBuilder;
  onFontChanged(body: string): ClippedTextBuilder;
  onFontInfoChanged(body: string): ClippedTextBuilder;
  onFontSizeModeChanged(body: string): ClippedTextBuilder;
  onHeightChanged(body: string): ClippedTextBuilder;
  onHorizontalAlignmentChanged(body: string): ClippedTextBuilder;
  onImplicitHeightChanged(body: string): ClippedTextBuilder;
  onImplicitWidthChanged(body: string): ClippedTextBuilder;
  onLeftPaddingChanged(body: string): ClippedTextBuilder;
  onLineCountChanged(body: string): ClippedTextBuilder;
  onLineHeightChanged(body: string): ClippedTextBuilder;
  onLineHeightModeChanged(body: string): ClippedTextBuilder;
  onLineLaidOut(body: string): ClippedTextBuilder;
  onLinkActivated(body: string): ClippedTextBuilder;
  onLinkColorChanged(body: string): ClippedTextBuilder;
  onLinkHovered(body: string): ClippedTextBuilder;
  onMaximumLineCountChanged(body: string): ClippedTextBuilder;
  onMinimumPixelSizeChanged(body: string): ClippedTextBuilder;
  onMinimumPointSizeChanged(body: string): ClippedTextBuilder;
  onObjectNameChanged(body: string): ClippedTextBuilder;
  onOpacityChanged(body: string): ClippedTextBuilder;
  onPaddingChanged(body: string): ClippedTextBuilder;
  onPaletteChanged(body: string): ClippedTextBuilder;
  onPaletteCreated(body: string): ClippedTextBuilder;
  onParentChanged(body: string): ClippedTextBuilder;
  onRenderTypeChanged(body: string): ClippedTextBuilder;
  onRenderTypeQualityChanged(body: string): ClippedTextBuilder;
  onRightPaddingChanged(body: string): ClippedTextBuilder;
  onRotationChanged(body: string): ClippedTextBuilder;
  onScaleChanged(body: string): ClippedTextBuilder;
  onSmoothChanged(body: string): ClippedTextBuilder;
  onStateChanged(body: string): ClippedTextBuilder;
  onStyleChanged(body: string): ClippedTextBuilder;
  onStyleColorChanged(body: string): ClippedTextBuilder;
  onTextChanged(body: string): ClippedTextBuilder;
  onTextFormatChanged(body: string): ClippedTextBuilder;
  onTopPaddingChanged(body: string): ClippedTextBuilder;
  onTransformOriginChanged(body: string): ClippedTextBuilder;
  onTruncatedChanged(body: string): ClippedTextBuilder;
  onVerticalAlignmentChanged(body: string): ClippedTextBuilder;
  onVisibleChanged(body: string): ClippedTextBuilder;
  onVisibleChildrenChanged(body: string): ClippedTextBuilder;
  onWidthChanged(body: string): ClippedTextBuilder;
  onWindowChanged(body: string): ClippedTextBuilder;
  onWrapModeChanged(body: string): ClippedTextBuilder;
  onXChanged(body: string): ClippedTextBuilder;
  onYChanged(body: string): ClippedTextBuilder;
  onZChanged(body: string): ClippedTextBuilder;
