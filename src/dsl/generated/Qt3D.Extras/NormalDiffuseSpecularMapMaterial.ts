...
export function NormalDiffuseSpecularMapMaterial(): NormalDiffuseSpecularMapMaterialBuilder {
  return createFluentBuilder('NormalDiffuseSpecularMapMaterial', NORMALDIFFUSESPECULARMAPMATERIAL_META) as unknown as NormalDiffuseSpecularMapMaterialBuilder;
}
