...
export interface WordCandidateListBuilder {
  ...
  autoCommitWord(value: boolean): WordCandidateListBuilder;
  autoCommitWordBind(expr: string): WordCandidateListBuilder;
  autoHideDelay(value: number): WordCandidateListBuilder;
  autoHideDelayBind(expr: string): WordCandidateListBuilder;
}
