...
export interface VoiceSelectorAttachedBuilder {
  ...
  gender(value: QmlEnumToken): VoiceSelectorAttachedBuilder;
  genderBind(expr: string): VoiceSelectorAttachedBuilder;
  language(value: string): VoiceSelectorAttachedBuilder;
  languageBind(expr: string): VoiceSelectorAttachedBuilder;
  locale(value: string): VoiceSelectorAttachedBuilder;
  localeBind(expr: string): VoiceSelectorAttachedBuilder;
  name(value: QmlValue): VoiceSelectorAttachedBuilder;
